...
**********************************************************************
-------------------------- END-OF-HEADER -----------------------------
File    : GUI_IP_ReversiDemo.c
Purpose : Lets you play the reversi game.
Literature:
Notes:
Additional information:
  Preperations:
    Plug in ethernet cable and connect with the emVNC
    tool to the shown IP address.
  Expected behavior:
    Starts a reversi game within an FRAMEWIN widget.
  Sample output:
    The user can play reversi against the AI by using
    the touch screen or a VNC client (connect to the
    shown IP address).
*/
...
#define WINDOW_SIZE_X     (191)
#define WINDOW_SIZE_Y     (218)
...
#if GUI_USE_ARGB
     0xFFFFFFFF,0xFFEEEEEE,0xFF777777,0xFF555555
    ,0xFF444444,0xFF000000,0xFF333333,0xFFDDDDDD
    ,0xFFCCCCCC,0xFF666666,0xFF9966FF,0xFF3333FF
    ,0xFFCCCCFF,0xFF3366FF,0xFF3300FF,0xFF9999FF
    ,0xFF99CCFF,0xFF6666FF,0xFF0000FF,0xFF888888
    ,0xFF222222,0xFF111111,0xFF999999,0xFFAAAAAA
    ,0xFFBBBBBB
#else
...
static void _StartReversi(void) {
  ...
  xPos = (LCD_GetXSize() - WINDOW_SIZE_X) / 2;
  yPos = (LCD_GetYSize() - WINDOW_SIZE_Y) / 2;
  _hFrame = FRAMEWIN_CreateEx(xPos, yPos, WINDOW_SIZE_X, WINDOW_SIZE_Y, WM_HBKWIN, WM_CF_SHOW, FRAMEWIN_CF_MOVEABLE, 0, NULL, &_cbReversiWin);
