...
Additional information:
  ...
  Expected behavior:
    The demo starts in auto-mode rotating the menu.
  Sample output:
    It shows a radial menu which can be moved by touch
    input. Switch off auto mode with the checkbox to
    gain manual control.
*/
...
static void _cbBk(WM_MESSAGE * pMsg) {
  ...
  case WM_PAINT:
    ...
    if (xSize < 320) {
      GUI_DispStringHCenterAt("Radial Menu with\nMotion Support", xSize / 2, 5);
    } else {
