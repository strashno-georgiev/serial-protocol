...
**********************************************************************
-------------------------- END-OF-HEADER -----------------------------
File    : GUI_HouseControlDemo.c
Purpose : Control the different components of the hous with
          the touch screen.
Literature:
Notes:
Additional information:
  ...
  Expected behavior:
    Showing a house which can be controlled by touch.
  Sample output:
    Showing a house and two windows. Use the control
    window to control the elevator, the light and the
    jalousies.
*/
...
static const GUI_WIDGET_CREATE_INFO _aDialogLight[] = {
  { WINDOW_CreateIndirect, "",           0,             0,   0, 113, 140, WM_CF_SHOW,   0, 0 },
  { TEXT_CreateIndirect,     "5.Floor:", 0,             5,   8,  40,  23, TEXT_CF_LEFT, 0, 0 },
  { TEXT_CreateIndirect,     "4.Floor:", 0,             5,  33,  40,  23, TEXT_CF_LEFT, 0, 0 },
  { TEXT_CreateIndirect,     "3.Floor:", 0,             5,  58,  40,  23, TEXT_CF_LEFT, 0, 0 },
  { TEXT_CreateIndirect,     "2.Floor:", 0,             5,  83,  40,  23, TEXT_CF_LEFT, 0, 0 },
  { TEXT_CreateIndirect,     "1.Floor:", 0,             5, 108,  40,  23, TEXT_CF_LEFT, 0, 0 },
  { SLIDER_CreateIndirect,   NULL,    GUI_ID_SLIDER4,  45,   4,  64,  23, 0,            0, 0 },
  { SLIDER_CreateIndirect,   NULL,    GUI_ID_SLIDER3,  45,  29,  64,  23, 0,            0, 0 },
  { SLIDER_CreateIndirect,   NULL,    GUI_ID_SLIDER2,  45,  54,  64,  23, 0,            0, 0 },
  { SLIDER_CreateIndirect,   NULL,    GUI_ID_SLIDER1,  45,  79,  64,  23, 0,            0, 0 },
  { SLIDER_CreateIndirect,   NULL,    GUI_ID_SLIDER0,  45, 104,  64,  23, 0,            0, 0 }
};
...
static const GUI_WIDGET_CREATE_INFO _aDialogMisc[] = {
  { WINDOW_CreateIndirect, "",           0,               0,   0, 113, 140, WM_CF_SHOW,      0, 0  },
  { BUTTON_CreateIndirect, "Jalousie 1", GUI_ID_BUTTON0,  5,   3, 103,  19, TEXT_CF_HCENTER, 0, 0  },
  { BUTTON_CreateIndirect, "Jalousie 2", GUI_ID_BUTTON1,  5,  24, 103,  19, TEXT_CF_HCENTER, 0, 0  },
  { BUTTON_CreateIndirect, "Marquee 1",  GUI_ID_BUTTON2,  5,  45, 103,  19, TEXT_CF_HCENTER, 0, 0  },
  { BUTTON_CreateIndirect, "Marquee 2",  GUI_ID_BUTTON3,  5,  66, 103,  19, TEXT_CF_HCENTER, 0, 0  },
  { BUTTON_CreateIndirect, "Garage",     GUI_ID_BUTTON4,  5,  87, 103,  19, TEXT_CF_HCENTER, 0, 0  },
  { BUTTON_CreateIndirect, "<",          GUI_ID_BUTTON5,  5, 108,  20,  19, TEXT_CF_HCENTER, 0, 0  },
  { BUTTON_CreateIndirect, "LogoStop",   GUI_ID_BUTTON6, 27, 108,  59,  19, TEXT_CF_HCENTER, 0, 0  },
  { BUTTON_CreateIndirect, ">",          GUI_ID_BUTTON7, 88, 108,  20,  19, TEXT_CF_HCENTER, 0, 0  }
};
...
static const GUI_WIDGET_CREATE_INFO _aDialogElev[] = {
  { WINDOW_CreateIndirect, "",      0,                9,   8, 113, 140, WM_CF_SHOW,      0, 0  },
  { BUTTON_CreateIndirect, "",      GUI_ID_BUTTON4,  16,  21,  16,  16, TEXT_CF_HCENTER, 0, 0 },
  { BUTTON_CreateIndirect, "",      GUI_ID_BUTTON3,  16,  39,  16,  16, TEXT_CF_HCENTER, 0, 0 },
  { BUTTON_CreateIndirect, "",      GUI_ID_BUTTON2,  16,  57,  16,  16, TEXT_CF_HCENTER, 0, 0 },
  { BUTTON_CreateIndirect, "",      GUI_ID_BUTTON1,  16,  75,  16,  16, TEXT_CF_HCENTER, 0, 0 },
  { BUTTON_CreateIndirect, "",      GUI_ID_BUTTON0,  16,  93,  16,  16, TEXT_CF_HCENTER, 0, 0 },
  { BUTTON_CreateIndirect, "Door",  GUI_ID_BUTTON5,  42,  21,  53,  16, TEXT_CF_HCENTER, 0, 0 },
  { BUTTON_CreateIndirect, "Pause", GUI_ID_BUTTON6,  42,  39,  53,  16, TEXT_CF_HCENTER, 0, 0 }
};
...
*/
  ...
  */
...
#if GUI_USE_ARGB
    0xFF000000, 0xFF272727, 0xFF434343, 0xFF646464,
    0xFF2020A0, 0xFF5656B7, 0xFF6666BE, 0xFF7474C4,
    0xFF8A8A8A, 0xFFBCBCBC, 0xFF8F8FCF, 0xFFABABDB,
    0xFFB9B9E1, 0xFFD6D6D6, 0xFFCDCDE9, 0xFFFEFEFE
#else
    0x000000, 0x272727, 0x434343, 0x646464,
    0xA02020, 0xB75656, 0xBE6666, 0xC47474,
    0x8A8A8A, 0xBCBCBC, 0xCF8F8F, 0xDBABAB,
    0xE1B9B9, 0xD6D6D6, 0xE9CDCD, 0xFEFEFE
#endif
  };
  ...
  static const unsigned char _acLogoSegger[] = {
    ...
    ,
    ...
    ,
...
*/
  ...
  *       _cbReceiveData
  */
  static void _cbReceiveData(U8 Data) {
...
static void _DrawElevator(int x, int y, int w, int h, int Level) {
  ...
  if (yPos != 80) {
    ...
    _DrawElevator2(x + 2, y + yPos, w - 4, 43, 0, y0, w - 4, y1, 1, GUI_MAKE_COLOR(Color1));
  }
  ...
  if (_Elevator.Move) {
    GUI_SetColor(Color2);
    GUI_FillRect(x + 2, y + 80, x + w - 2, y + h - 2);
    _DrawElevator2(x + 2, y + yPos, w - 4, 43, 0, y0, w - 4, y1, 1, GUI_MAKE_COLOR(Color2));
  } else {
    int Door = (w - 4) * (100 - _Elevator.Door.ActV) / 100;
    _DrawElevator2(x + 2, y + yPos, w - 4, 43, 0, y0, Door, y1, 1, GUI_MAKE_COLOR(Color2));
    _DrawElevator2(x + 2, y + yPos, w - 4, 43, Door + 1, y0, w - 4, y1, 0, GUI_MAKE_COLOR(Color2));
  }
...
static int _DrawRotateLogo(void) {
  if (_LogoRPM != 0) {
    if ((GUI_GetTime() - _LogoPrevTime) >= _LogoWaitTime) {
      ...
      _LogoMulX     = (int)(cos(_LogoAngle) * LOGOMULX);
...
static void _DrawHouseMap(int x0, int y0) {
  ...
  ElevatorY = (int)(y0 + (_Elevator.Itself.ActV / (10. / 3.)) + 25);
...
static void _ElevatorDelLevel(int Level) {
  ...
  if (_Level[Level].Elevator != 0 && Level < 5) {
    ...
    for (; (i < (_Elevator.NumToDo - 1)) && ((U32)i < GUI_COUNTOF(_Elevator.ToDo) - 1); i++) {
...
static void _House_Demo(void) {
  ...
  hFrame = FRAMEWIN_Create("House", 0, WM_CF_SHOW, 70, 28, 170, 151);
