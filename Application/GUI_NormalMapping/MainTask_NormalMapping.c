...
extern const unsigned short          _acSegger_NM_800x480[]; // Normal map
extern const unsigned char           _acSegger_800x480[100670UL + 1];    // Image (JPEG)
...
#define NORMAL_MAP          _acSegger_NM_800x480
#define BM_IMAGE            _acSegger_800x480
