...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { FRAMEWIN_CreateIndirect, "Transparent dialog", 0,              0,   0,  FRAMEWIN_XSIZE, 100, FRAMEWIN_CF_MOVEABLE, 0, 0 },
  { TEXT_CreateIndirect,     "Background:",        GUI_ID_TEXT0,   5,   10, TEXT_XSIZE,     20,  TEXT_CF_LEFT        , 0, 0 },
  { TEXT_CreateIndirect,     "Title:",             GUI_ID_TEXT1,   5,   40, TEXT_XSIZE,     20,  TEXT_CF_LEFT        , 0, 0 },
  { SLIDER_CreateIndirect,   NULL,                 GUI_ID_SLIDER0, 100, 10, SLIDER_XSIZE,   20,  0                   , 0, 0 },
  { SLIDER_CreateIndirect,   NULL,                 GUI_ID_SLIDER1, 100, 40, SLIDER_XSIZE,   20,  0                   , 0, 0 }
};
...
static void _cbBk(WM_MESSAGE * pMsg) {
  static GUI_MEMDEV_Handle hMemBk;
  GUI_MEMDEV_Handle        hMemOrg;
  static int xAdd;
  static int yAdd;
  static int xPos;
  static int yPos;
  ...
  case APP_INIT:
    ...
    hMemBk = GUI_MEMDEV_Create(0, 0, _bmMap_400x320.XSize, _bmMap_400x320.YSize);
    if (hMemBk) {
      hMemOrg = GUI_MEMDEV_Select(hMemBk);
      GUI_DrawBitmap(&_bmMap_400x320, 0, 0);
      GUI_MEMDEV_Select(hMemOrg);
    }
    break;
  case APP_TIMER:
    xSizeBmp      = _bmMap_400x320.XSize;
  ...
  case WM_PAINT:
    ...
    if (hMemBk) {
      GUI_MEMDEV_WriteAt(hMemBk, xPos, yPos);
    } else {
