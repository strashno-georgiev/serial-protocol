...
REM
REM call cc      Tool html\css       bootstrap_min_css              css
REM call cc      Tool html           Custom                         css
REM call cc      Tool html\js        bootstrap_min_js               js
REM call cc      Tool html\js        events                         js
REM call cc      Tool html\js        jquery_min_js                  js
REM call cc      Tool html\js        tether_min_js                  js
REM call cc      Tool html\js        RGraphCC                       js
REM call cc      Tool html\js        RGraphCE                       js
REM call cc      Tool html\js        RGraphLi                       js
...
call cc      Tool html           emNet_Icon                     gif
