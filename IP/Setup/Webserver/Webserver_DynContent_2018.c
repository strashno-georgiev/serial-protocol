...
//
static U32        _Cnt;
static U32        _SSEUpdates;            // Counter to visualize the number of updates sent by the Web server to client without reload of the page.
...
static void _callback_ExecCounter(WEBS_OUTPUT* pOutput, const char* sParameters, const char* sValue ) {
  ...
  _Cnt++;
  _SSEUpdates = 0;                             // Reset the SSE update cnt with every reload of the page.
  IP_WEBS_SendFormattedString(pOutput, "Current page load count: %lu", _Cnt);
}
...
*
*  Function description
*    Adds the system uptime to the output buffer
*/
static void _SSE_AddSystemTime(WEBS_OUTPUT* pOutput) {
  U32 Time;
  //
  // Get system uptime and send it to the browser
  //
#ifdef _WIN32
  Time = GetTickCount();
#else
  Time = OS_GetTime32();
#endif
  IP_WEBS_SendString(pOutput, "event: LOG_SysUptime\n");     // Write name of the Javascript event in the output buffer.
  IP_WEBS_SendString(pOutput, "data: ");
  IP_WEBS_SendString(pOutput, "| System uptime: ");
...
*
*  Function description
*    Updates and adds the SSE update counter of the web page.
*/
static void _SSE_AddUpdateCnt(WEBS_OUTPUT* pOutput) {
  _SSEUpdates++;
  IP_WEBS_SendString(pOutput, "event: LOG_SSEUpdates\n");    // Write name of the Javascript event in the output buffer.
  IP_WEBS_SendString(pOutput, "data: ");
  IP_WEBS_SendString(pOutput, " (SSE updates: ");
  IP_WEBS_SendUnsigned(pOutput, _SSEUpdates, 10, 0);
  IP_WEBS_SendString(pOutput, ")");
  IP_WEBS_SendString(pOutput, "\n\n");                       // End of the SSE data
}
...
*
*  Parameter
*    pOutput: Pointer to WEBS_OUTPUT
*    UseSSE:
*/
static int _GetOSShortInfo(WEBS_OUTPUT* pOutput, unsigned UseSSE) {
  int      r;

#ifdef _WIN32
  if (UseSSE == 1) {
    IP_WEBS_SendString(pOutput, "event: LOG_OSOverview\n");     // Write name of the Javascript event in the output buffer.
    IP_WEBS_SendString(pOutput, "data: ");                      // Start of SSE data
  }
  ...
  IP_WEBS_SendString(pOutput, "<div class=\"textBlock\">");
  //
  // Output embOS information
  //
  IP_WEBS_SendString(pOutput, "<div class=\"row\">");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-12\">");
  IP_WEBS_SendString(pOutput, "<h2>embOS system information</h2>");
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "</div>");

  IP_WEBS_SendString(pOutput, "<div class=\"row\">");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-5\">");
  IP_WEBS_SendString(pOutput, "<span>Number of tasks</span><br>");
  IP_WEBS_SendString(pOutput, "<span>System time</span><br>");
  IP_WEBS_SendString(pOutput, "<span>System stack (size@base)</span><br>");
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-7\">");
  IP_WEBS_SendString(pOutput, "<span>");
  OS_EnterRegion();
  ...
  if (UseSSE == 1) {
    IP_WEBS_SendString(pOutput, "\n\n");                      // End of the SSE data
    IP_WEBS_SendString(pOutput, "event: LOG_TaskInfo\n");     // Write name of the Javascript event in the output buffer.
    IP_WEBS_SendString(pOutput, "data: ");                    // Start of SSE data
  }
  //
  ...
  //
  IP_WEBS_SendString(pOutput, "<div class=\"row\">");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-12\" id=\"tableArea\">");
  IP_WEBS_SendString(pOutput, "<h2>List of tasks</h2>");
  IP_WEBS_SendString(pOutput, "<table class=\"table table-striped table-condensed\">");
  IP_WEBS_SendString(pOutput, "<tr>");
  IP_WEBS_SendString(pOutput, "<th>Id</th>");
  IP_WEBS_SendString(pOutput, "<th>Priority</th>");
  IP_WEBS_SendString(pOutput, "<th>Task names</th>");
  IP_WEBS_SendString(pOutput, "<th>Context switches</th>");
  IP_WEBS_SendString(pOutput, "<th>Task Stack</th>");
  IP_WEBS_SendString(pOutput, "</tr>");
  ...
  if (UseSSE == 1) {
    IP_WEBS_SendString(pOutput, "\n\n");                       // End of the SSE data
    _SSE_AddUpdateCnt(pOutput);
    _SSE_AddSystemTime(pOutput);
  }
  r = IP_WEBS_Flush(pOutput);                                  // Send the data to the Web browser.
  return r;
}
...
*
*  Function description
*    Sends the network configuration of the target information
*    and the connection information to the browser.
*/
static void _GetIPAddrInfo(WEBS_OUTPUT* pOutput) {
#ifndef _WIN32
  char                 acBuffer[40];
  U32                  IPAddr;
#if IP_SUPPORT_IPV6
  ...
  // Output IPv4 address
  //
  IP_WEBS_SendString(pOutput, "<div class=\"row\" id=\"LOG_AddrInfo\">");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-12\">");
  IP_WEBS_SendString(pOutput, "<h2>Address info</h2>");
  IP_WEBS_SendString(pOutput, "<b>-- IPv4 --------------------</b>");
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "</div>");

  IP_WEBS_SendString(pOutput, "<div class=\"row\" id=\"LOG_AddrInfo\">");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-4\">");
  IP_WEBS_SendString(pOutput, "<span>IPv4 address:</span>");
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-8\">");
  IP_WEBS_SendString(pOutput, "<span>");
  ...
  IP_WEBS_SendString(pOutput, "<div class=\"row\" id=\"LOG_AddrInfo\">");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-4\">");
  IP_WEBS_SendString(pOutput, "<span>Gateway:</span>");
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-8\">");
  IP_WEBS_SendString(pOutput, "<span>");
  IP_WEBS_SendString(pOutput, acBuffer);
  ...
  IP_WEBS_SendString(pOutput, "<div class=\"row\" id=\"LOG_AddrInfo\">");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-12\">");
  IP_WEBS_SendString(pOutput, "<b>-- IPv6 --------------------</b>");
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "</div>");

  IP_WEBS_SendString(pOutput, "<div class=\"row\" id=\"LOG_AddrInfo\">");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-4\">");
  IP_WEBS_SendString(pOutput, "<span>IPv6 address:</span>");
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-8\">");
  IP_WEBS_SendString(pOutput, "<span>");
  IP_WEBS_SendString(pOutput, acBuffer);
...
*
*  Function description
*    Sends the network configuration of the target to the browser.
*/
static void _GetConnCnt(WEBS_OUTPUT* pOutput) {
#ifdef _WIN32
  ...
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "</div>");  // HTML: class="row"
  OS_LeaveRegion();
  IP_WEBS_SendString(pOutput, "\n\n");          // End of the SSE data
#endif
}
...
*
*  Function description
*    Sends the connection information to the browser.
*/
static int _GetConnInfo(WEBS_OUTPUT* pOutput) {
  int                  r;

#ifdef _WIN32
  IP_WEBS_SendString(pOutput, "event: LOG_ConnectionCnt\n");   // Write name of the Javascript event in the output buffer.
  IP_WEBS_SendString(pOutput, "data: ");                       // Start of the SSE data block
  IP_WEBS_SendString(pOutput, "<H2>This sample runs on a Windows host.<br>No network statistics available.</H2>");
#else
  IP_CONNECTION_HANDLE hConnection[MAX_CONNECTION_INFO];
  ...
  IP_WEBS_SendUnsigned(pOutput, NumValidConnections, 10, 0);
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "</div>");                       // HTML: <!-- textblock -->
  IP_WEBS_SendString(pOutput, "\n\n");                         // End of the SSE data block
  IP_WEBS_SendString(pOutput, "event: LOG_ConnectionInfo\n");  // Write name of the Javascript event in the output buffer.
  IP_WEBS_SendString(pOutput, "data: ");                       // Start of the next SSE data block
#if 0
  //
  ...
  IP_WEBS_SendString(pOutput, "<th>Local<br>Peer</th>");
  IP_WEBS_SendString(pOutput, "<th>LPort<br>FPort</th>");
  IP_WEBS_SendString(pOutput, "<th>State</th>");
  IP_WEBS_SendString(pOutput, "<th>MTU<br>MSS</th>");
  IP_WEBS_SendString(pOutput, "<th>Retr.<br>delay</th>");
  IP_WEBS_SendString(pOutput, "<th>Idle time</th>");
  IP_WEBS_SendString(pOutput, "<th>Local<br>win</th>");
  IP_WEBS_SendString(pOutput, "<th>Peer win</th>");
  IP_WEBS_SendString(pOutput, "</tr>");
  for (i = 0; i < NumConnections; i++) {
#if IP_SUPPORT_IPV6
    r = IP_IPV6_INFO_GetConnectionInfo(hConnection[i], &Info);
    ...
    if (r == 0) {
      ...
      if (Info.LocalAddr == 0) {
        ...
        IP_PrintIPAddr(acBuffer, Info.LocalAddr, sizeof(acBuffer));
        IP_WEBS_SendString(pOutput, acBuffer);
      }
      IP_WEBS_SendString(pOutput, "<br>");
      //
      ...
      if (Info.ForeignAddr == 0) {
        ...
        IP_PrintIPAddr(acBuffer, Info.ForeignAddr, sizeof(acBuffer));
        IP_WEBS_SendString(pOutput, acBuffer);
#endif
      }
...
/*********************************************************************
*
*       _callback_ExecGetIPAddrInfo
*/
static void _callback_ExecGetIPAddrInfo(WEBS_OUTPUT* pOutput, const char* sPara, const char* sValue) {
  WEBS_USE_PARA(sPara);
  WEBS_USE_PARA(sValue);
  _GetIPAddrInfo(pOutput);
}
...
/*********************************************************************
*
*       _callback_ExecGetDropdown
*
*  Function description:
*    Sends the content of the dropdown menu.
*/
static void _callback_ExecGetDropdown(WEBS_OUTPUT* pOutput, const char* sPara, const char* sValue) {
  WEBS_USE_PARA(sPara);
  WEBS_USE_PARA(sValue);

  IP_WEBS_SendString(pOutput, "<a class=\"nav-link dropdown-toggle\" href=\"#\" id=\"dropdown04\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"true\">Samples</a>");
  IP_WEBS_SendString(pOutput, "<div class=\"dropdown-menu\" aria-labelledby=\"dropdown04\">");
  IP_WEBS_SendString(pOutput, "<h6 class=\"dropdown-header\">Simple samples</h6>");
  IP_WEBS_SendString(pOutput, "<a class=\"dropdown-item\" href=\"FormGET.htm\">Form (\"GET\")</a>");
  IP_WEBS_SendString(pOutput, "<a class=\"dropdown-item\" href=\"FormPOST.htm\">Form (\"POST\")</a> ");
  IP_WEBS_SendString(pOutput, "<a class=\"dropdown-item\" href=\"VirtFile.htm\">Virtual file</a>");
  IP_WEBS_SendString(pOutput, "<a class=\"dropdown-item\" href=\"/conf/Authen.htm\">Basic authentication</a>");
  IP_WEBS_SendString(pOutput, "<a class=\"dropdown-item\" href=\"Samples.htm\">Sitemap</a>");
  IP_WEBS_SendString(pOutput, "<h6 class=\"dropdown-header\">SSE samples</h6>");
//  IP_WEBS_SendString(pOutput, "<a class=\"dropdown-item\" href=\"SSE_Time.htm\">System time</a>");
  IP_WEBS_SendString(pOutput, "<a class=\"dropdown-item\" href=\"index.htm\">Network statistics</a>");
  IP_WEBS_SendString(pOutput, "<a class=\"dropdown-item\" href=\"OSInfo.htm\">embOS statistics</a>");
#if INCLUDE_SHARE_SAMPLE || INCLUDE_PRESENTATION_SAMPLE
  IP_WEBS_SendString(pOutput, "<h6 class=\"dropdown-header\">SSE/AJAX samples</h6>");
#endif
#if INCLUDE_SHARE_SAMPLE
  IP_WEBS_SendString(pOutput, "<a class=\"dropdown-item\" href=\"Shares.htm\">Stock quotes sample</a>");
#endif
#if INCLUDE_PRESENTATION_SAMPLE
  IP_WEBS_SendString(pOutput, "<a class=\"dropdown-item\" href=\"Products.htm\">Product presentation</a>");
#endif
  IP_WEBS_SendString(pOutput, "</div>");
}
...
/*********************************************************************
*
*       _callback_ExecGetConfigMenuItem
*
*  Function description:
*    Sends the config menu item if enabled..
*/
static void _callback_ExecGetConfigMenuItem(WEBS_OUTPUT* pOutput, const char* sPara, const char* sValue) {
  WEBS_USE_PARA(pOutput);
  WEBS_USE_PARA(sPara);
  WEBS_USE_PARA(sValue);

#if INCLUDE_IP_CONFIG_SAMPLE
  IP_WEBS_SendString(pOutput, "<li class=\"nav-item\">");
  IP_WEBS_SendString(pOutput, "<a class=\"nav-link\" href=\"/IPConfig.htm\">Config</a>");
  IP_WEBS_SendString(pOutput, "</li>");
#endif
}
...
/*********************************************************************
*
*       _callback_ExecGetSamples
*
*  Function description:
*    Sends the content of the samples page.
*    We use a dynamic web page to generate the content to enhance
*    the portability of the sample.
*/
static void _callback_ExecGetSamples(WEBS_OUTPUT* pOutput, const char* sPara, const char* sValue) {
  WEBS_USE_PARA(sPara);
  WEBS_USE_PARA(sValue);

  IP_WEBS_SendString(pOutput, "<div class=\"index\">");
  ...
  IP_WEBS_SendString(pOutput, "<li><a href=\"Samples.htm\">Sitemap</a><br>");
...
#endif
#if INCLUDE_IP_CONFIG_SAMPLE
  IP_WEBS_SendString(pOutput, "<li><a href=\"/IPConfig.htm\">IP Configuration</a><br>");
#endif
  IP_WEBS_SendString(pOutput, "</ul>");
  IP_WEBS_SendString(pOutput, "<h3>System info samples using Server-Sent Events (SSE)</h3><ul>");
#ifdef _WIN32
...
#else
  IP_WEBS_SendString(pOutput, "<li><a href=\"index.htm\">Network statistics</a><br>");
  IP_WEBS_SendString(pOutput, "<li><a href=\"OSInfo.htm \">embOS statistics</a><br></ul>");
#endif
...
static void _callback_CGI_Send(WEBS_OUTPUT* pOutput, const char* sParameters) {
  ...
  if (r == 0) {
    ...
    IP_WEBS_SendString(pOutput, "</div>");
    IP_WEBS_SendString(pOutput, "<div class=\"textBlock\">");
    IP_WEBS_SendString(pOutput, "This page is generated by the emWeb Web server. It can not be accessed with the used file system. ");
    IP_WEBS_SendString(pOutput, "To modifiy this page, open the file <keyword>Webserver_DynContent.c</keyword> and modify the function <keyword>_callback_CGI_Send()</keyword>.");
    IP_WEBS_SendString(pOutput, "</div>");
  } else {
...
*
*  Function description:
*    Gets the system time and writes it with the SSE required header
*    information in the buffer.
*/
static void _GetSystemTime(WEBS_OUTPUT* pOutput) {
  U32 Time;
...
*       _SendConnectionCnt
*/
static int _SendConnectionCnt(WEBS_OUTPUT* pOutput) {
  int r;
...
/*********************************************************************
*
*       _callback_CGI_SSEConnCnt
*
*  Function description:
*    Sends some network information to the Web browser every 500 ms.
*/
static void _callback_CGI_SSEConnCnt(WEBS_OUTPUT* pOutput, const char* sParameters) {
  int r;
...
/*********************************************************************
*
*       _callback_CGI_SSEGetConnInfo
*
*  Function description:
*    Sends some network information to the Web browser every 500 ms.
*/
static void _callback_CGI_SSEGetConnInfo(WEBS_OUTPUT* pOutput, const char* sParameters) {
  int r;
...
/*********************************************************************
*
*       _callback_CGI_SSEMaintenanceInfo
*
*  Function description:
*    Sends system time and SSE update counter.
*/
static void _callback_CGI_SSEMaintenanceInfo(WEBS_OUTPUT* pOutput, const char* sParameters) {
  int r;
...
static void _callback_CGI_GetDetails(WEBS_OUTPUT* pOutput, const char* sParameters) {
  ...
  if (strcmp(acPara, "embOSMPU") == 0) {
    IP_WEBS_SendString(pOutput, "<div class=\"textBlock\">");
    IP_WEBS_SendString(pOutput, "<h2>embOS-MPU - The Heart of Every Safety-Critical IoT Device</h2>");
    IP_WEBS_SendString(pOutput, "<b>embOS-MPU</b> offers memory protection on top of the proven real-time operating system embOS. It significantly enhances both stability and safety of your embedded applications and thereby simplifies any certification process. The operating system and all tasks deemed privileged are memory protected and isolated from any ill affects of unprivileged tasks.");
    IP_WEBS_SendString(pOutput, "<br><br><b>Features</b><ul>");
    IP_WEBS_SendString(pOutput, "<ul>");
    IP_WEBS_SendString(pOutput, "<li>Comprehensive memory protection.</li>");
    IP_WEBS_SendString(pOutput, "<li>Unprivileged tasks 100% sandboxed.</li>");
    IP_WEBS_SendString(pOutput, "<li>Suitable for any safety-critical application.</li></ul>");
    IP_WEBS_SendString(pOutput, "<br><br><a href=\"https://www.segger.com/products/rtos/embos/technology/embos-mpu/embos-mpu-basic-concepts/\" target=\"_blank\">https://www.segger.com/products/rtos/embos/technology/embos-mpu/embos-mpu-basic-concepts/</a> <span class=\"hint\"><br>(external link, an internet connection is required)</span>");
    IP_WEBS_SendString(pOutput, "</div>");
  } else if (strcmp(acPara, "emSSH") == 0) {
    IP_WEBS_SendString(pOutput, "<div class=\"textBlock\">");
    IP_WEBS_SendString(pOutput, "<h2>emSSH - Provide Security for The Administration Interface of Your Device</h2>");
    IP_WEBS_SendString(pOutput, "<b>emSSH</b> is a software library that enables secure login to your embedded system. emSSH offers the possibility to establish a secured connection to any server application in your product. It can be used both target independently in native computer applications and in embedded targets.");
    IP_WEBS_SendString(pOutput, "<br><br><b>Features</b><ul>");
    IP_WEBS_SendString(pOutput, "<ul>");
    IP_WEBS_SendString(pOutput, "<li>Secures your connection.</li>");
    IP_WEBS_SendString(pOutput, "<li>Compatible with popular SSHv2 clients.</li>");
    IP_WEBS_SendString(pOutput, "<li>Supports popular hardware cryptography accelerators.</li></ul>");
    IP_WEBS_SendString(pOutput, "<br><br><a href=\"https://www.segger.com/products/security-iot/emssh/\" target=\"_blank\">https://www.segger.com/products/security-iot/emssh/</a> <span class=\"hint\"><br>(external link, an internet connection is required)</span>");
    IP_WEBS_SendString(pOutput, "</div>");
  } else if (strcmp(acPara, "emSSL") == 0) {
    IP_WEBS_SendString(pOutput, "<div class=\"textBlock\">");
    IP_WEBS_SendString(pOutput, "<h2>emSSL - Reliable, Secure and Built for IoT Devices</h2>");
    IP_WEBS_SendString(pOutput, "<b>emSSL</b> is a software library that enables secure connections across the Internet. emSSL offers both client and server capability. SSL/TLS is a must-have in nearly every application which is connected to the Internet. Products of the IoT, smart grid or home automation markets benefit from securing their communication.");
    IP_WEBS_SendString(pOutput, "<br><br><b>Features</b><ul>");
    IP_WEBS_SendString(pOutput, "<ul>");
    IP_WEBS_SendString(pOutput, "<li>Secures your connection.</li>");
    IP_WEBS_SendString(pOutput, "<li>Compatible with any modern server.</li>");
    IP_WEBS_SendString(pOutput, "<li>Easy to understand.</li></ul>");
    IP_WEBS_SendString(pOutput, "<br><br><a href=\"https://www.segger.com/products/security-iot/emssl/\" target=\"_blank\">https://www.segger.com/products/security-iot/emssl/</a> <span class=\"hint\"><br>(external link, an internet connection is required)</span>");
    IP_WEBS_SendString(pOutput, "</div>");
  } else if (strcmp(acPara, "emNet") == 0) {
    IP_WEBS_SendString(pOutput, "<div class=\"textBlock\">");
    IP_WEBS_SendString(pOutput, "<h2>emNet - Ideal for Any Network Application</h2>");
    ...
    IP_WEBS_SendString(pOutput, "<br><br><b>Features</b><ul>");
    IP_WEBS_SendString(pOutput, "<ul>");
    IP_WEBS_SendString(pOutput, "<li>IPv4 and IPv6 ready.</li>");
    ...
    IP_WEBS_SendString(pOutput, "<li>Various application layer protocols like MQTT, HTTP, FTP available.</li></ul>");
    IP_WEBS_SendString(pOutput, "<br><br><a href=\"https://www.segger.com/emnet/\" target=\"_blank\">https://www.segger.com/emnet/</a> <span class=\"hint\"><br>(external link, an internet connection is required)</span>");
    IP_WEBS_SendString(pOutput, "</div>");
  } else if (strcmp(acPara, "emFile") == 0) {
    IP_WEBS_SendString(pOutput, "<div class=\"textBlock\">");
    IP_WEBS_SendString(pOutput, "<h2>emFile - Reliable Data Storage for Your IoT Device</h2>");
    IP_WEBS_SendString(pOutput, "<b>emFile</b> is a file system for embedded applications, which can be used on any media, for which you can provide basic hardware access functions.");
    IP_WEBS_SendString(pOutput, "<br><br><b>Features</b><ul>");
    IP_WEBS_SendString(pOutput, "<ul>");
    ...
    IP_WEBS_SendString(pOutput, "<li>Works with any operating system to accomplish a thread-safe environment.</li></ul>");
    IP_WEBS_SendString(pOutput, "<br><br><a href=\"https://www.segger.com/products/file-system/emfile/\" target=\"_blank\">https://www.segger.com/products/file-system/emfile/</a> <span class=\"hint\"><br>(external link, an internet connection is required)</span>");
    IP_WEBS_SendString(pOutput, "</div>");
  } else if (strcmp(acPara, "emWin") == 0) {
    IP_WEBS_SendString(pOutput, "<div class=\"textBlock\">");
    IP_WEBS_SendString(pOutput, "<h2>emWin - Visualize Your Ideas</h2>");
    ...
    IP_WEBS_SendString(pOutput, "<br><br><a href=\"https://www.segger.com/products/user-interface/emwin/\" target=\"_blank\">https://www.segger.com/products/user-interface/emwin/</a> <span class=\"hint\"><br>(external link, an internet connection is required)</span>");
    IP_WEBS_SendString(pOutput, "</div>");
  } else if (strcmp(acPara, "emLoad") == 0) {
    IP_WEBS_SendString(pOutput, "<div class=\"textBlock\">");
    IP_WEBS_SendString(pOutput, "<h2>emLoad - Make Software Updates of Your IoT Device Easy</h2>");
    IP_WEBS_SendString(pOutput, "<b>emLoad</b> allows straightforward updates of embedded applications either with a USB stick, with an SD card or via USB-connection to a PC - or else via a serial connection (type RS-232, RS-485).");
    IP_WEBS_SendString(pOutput, "<br><br><b>Features</b>");
    IP_WEBS_SendString(pOutput, "<ul>");
    ...
    IP_WEBS_SendString(pOutput, "<li>Completely portable and runs on any target.</li></ul>");
    IP_WEBS_SendString(pOutput, "<br><br><a href=\"https://www.segger.com/products/field-upgrades/emload/\" target=\"_blank\">https://www.segger.com/products/field-upgrades/emload/</a> <span class=\"hint\"><br>(external link, an internet connection is required)</span>");
    IP_WEBS_SendString(pOutput, "</div>");
  } else if (strcmp(acPara, "emUSBD") == 0) {
    IP_WEBS_SendString(pOutput, "<div class=\"textBlock\">");
    IP_WEBS_SendString(pOutput, "<h2>emUSB Device - Boost Your Connectivity</h2>");
    IP_WEBS_SendString(pOutput, "<b>emUSB-Device</b> is a high performance USB device stack specifically designed for embedded systems. The software is written in ANSI C and can run on any platform. A variety of target drivers are already available.");
    IP_WEBS_SendString(pOutput, "<br><br><b>Features</b><ul>");
    IP_WEBS_SendString(pOutput, "<li>Support for various device classes like MTP, MSD, CDC, HID and RNDIS available.</li>");
    ...
    IP_WEBS_SendString(pOutput, "<br><br><a href=\"https://www.segger.com/products/connectivity/emusb-device/\" target=\"_blank\">https://www.segger.com/products/connectivity/emusb-device/</a> <span class=\"hint\"><br>(external link, an internet connection is required)</span>");
    IP_WEBS_SendString(pOutput, "</div>");
  } else if (strcmp(acPara, "emUSBH") == 0) {
    IP_WEBS_SendString(pOutput, "<div class=\"textBlock\">");
    IP_WEBS_SendString(pOutput, "<h2>emUSB Host - Enhance Your IoT Device Through the Use of USB Host</h2>");
    IP_WEBS_SendString(pOutput, "<b>emUSB-Host</b> implements full USB host functionality, including external hub support, and optionally provides device class drivers. It enables developers to easily add USB host functionality to embedded systems.");
    IP_WEBS_SendString(pOutput, "<br><br><b>Features</b><ul>");
    IP_WEBS_SendString(pOutput, "<li>Control, bulk and interrupt and isochronous transfers</li>");
    IP_WEBS_SendString(pOutput, "<li>Runs out-of-the-box</li>");
    IP_WEBS_SendString(pOutput, "<li>No configuration required</li>");
    IP_WEBS_SendString(pOutput, "<br><br><a href=\"https://www.segger.com/products/connectivity/emusb-host/\" target=\"_blank\">https://www.segger.com/products/connectivity/emusb-host/</a> <span class=\"hint\"><br>(external link, an internet connection is required)</span>");
    IP_WEBS_SendString(pOutput, "</div>");
  } else {
    IP_WEBS_SendString(pOutput, "<div class=\"textBlock\">");
    IP_WEBS_SendString(pOutput, "<center><b>Please click on one of the pictures to select a product.</b></center>");
    IP_WEBS_SendString(pOutput, "</div>");
  }
}
...
*    fictional companies.
*/
static int _SendShareTable(WEBS_OUTPUT* pOutput) {
  float Percentage;
  int   Curr;
  int   Pre;
  int   Trend;
  ...
  IP_WEBS_SendString(pOutput, "event: Shares\n");     // Write name of the Javascript event in the output buffer.
  IP_WEBS_SendString(pOutput, "data: ");
  //
  // Send table with sample shares to the client.
  //
  IP_WEBS_SendString(pOutput, "<div class=\"row\">");
  IP_WEBS_SendString(pOutput, "<div class=\"col-md-12\">");
  IP_WEBS_SendString(pOutput, "<h3>Stock prices</h3>");
  IP_WEBS_SendString(pOutput, "<table class=\"table table-striped table-condensed\">");
  IP_WEBS_SendString(pOutput, "<tr>");
  IP_WEBS_SendString(pOutput, "<th class=\"text-left\">Company</th>");
  IP_WEBS_SendString(pOutput, "<th class=\"text-center\">Current price</th>");
  IP_WEBS_SendString(pOutput, "<th class=\"text-center\">Trend</th>");
  IP_WEBS_SendString(pOutput, "<th class=\"text-right\">Change</th>");
  IP_WEBS_SendString(pOutput, "<th class=\"text-right\">Change %</th>");
  IP_WEBS_SendString(pOutput, "</tr>");
  for (i = 0; i < 2; i++) {
    //
    ...
    //
    IP_WEBS_SendString(pOutput, "<td class=\"text-center\">");
    ...
    IP_WEBS_SendString(pOutput, "<td class=\"text-center\">");
    switch(Trend) {
    case -1: IP_WEBS_SendString(pOutput, "<img src=\"RedRDown.gif\" alt=\"Pointer down\">");  break;
    case  0: IP_WEBS_SendString(pOutput, "<img src=\"WhiteR.gif\" alt=\"Pointer right\">");  break;
    case  1: IP_WEBS_SendString(pOutput, "<img src=\"GreenRUp.gif\" alt=\"Pointer up\">");  break;
    }
    IP_WEBS_SendString(pOutput, "</td><td class=\"text-right\">");
    //
    ...
    //
    IP_WEBS_SendString(pOutput, "<td class=\"text-right\">");
    if (Percentage < 0) {
      IP_WEBS_SendString(pOutput, "-");
      Percentage *= -1;
    }
...
static void _callback_CGI_SSEGetShareTable(WEBS_OUTPUT* pOutput, const char* sParameters) {
  ...
  IP_WEBS_SendString(pOutput, "retry: 1000\n");  // Normally, the browser attempts to reconnect to the server ~3 seconds after each connection is closed. We change that timeout 1 sec.
  while(1) {
    r = _SendShareTable((void*)pOutput);
    if (r == 0) {     // Data transmitted, Web browser is still waiting for new data.
#ifdef _WIN32
      Sleep(500);
#else
...
/*********************************************************************
*
*       _callback_IPv4ConfigType
*
*  Function description
*    Sends a forward to inform the browser about the new configured
*    static IP.
*
*  Notes:
*    e.g.: <meta http-equiv="refresh" content="0;URL=http://192.168.11.22/">
*/
static void _SendForwardPage(WEBS_OUTPUT* pOutput) {
  char aIPAddr[16];

#if (WEBS_USE_ENHANCED_FORM_HANDLING == 0)
  IP_WEBS_SendHeader(pOutput, "Forward.htm", NULL);
#else
  {
    WEBS_HEADER_CONFIG HeaderConfig;

    memset(&HeaderConfig, 0, sizeof(HeaderConfig));
    HeaderConfig.sFileName = "Forward.htm";
    IP_WEBS_SendHeader(pOutput, &HeaderConfig);
  }
#endif
  IP_WEBS_SendString(pOutput, "<html><head><meta http-equiv=\"refresh\" content=\"5;URL=http://");
  IP_PrintIPAddrEx(aIPAddr, sizeof(aIPAddr), (const U8*)&_IPAddr, 4);
  IP_WEBS_SendString(pOutput, aIPAddr);
  IP_WEBS_SendString(pOutput, "/\"></head></html>");
...
*
*  Function description
*    Sets the configuration type of the target.
*/
static void _callback_IPv4ConfigType(WEBS_OUTPUT* pOutput, const char* sPara, const char* sValue) {
  int v;
  ...
  if (sValue != NULL) {
    ...
    if (v == 1) {
      if (_DHCPOnOff == 0) {                      // Is DHCP client disabled ?
        IP_DHCPC_ConfigAlwaysStartInit(0, 1);
        (void)IP_DHCPC_Activate(0, NULL, NULL, NULL);   // Enable DHCP client.
      }
    } else {
      if (_DHCPOnOff != 0) {                      // Is DHCP client enabled ?
        (void)IP_DHCPC_Halt(0);
        _SendForward = 1;                         // If the configuration changes from DHCP to static IP, the Web server should send a forward to the new IP address.
      }
    }
    _DHCPOnOff = SEGGER_atoi(sValue);             // Update DHCP state.
  }
}
...
static const WEBS_VFILES _aVFiles[]  = {
...
#endif
  {"MaintenanceInfo.cgi",   _callback_CGI_SSEMaintenanceInfo  },   // Called from various Web pages.
  ...
  {"SSEGetConnInfo.cgi",    _callback_CGI_SSEGetConnInfo      },   // Called from index.htm
  {"SSEConnCnt.cgi",        _callback_CGI_SSEConnCnt          },   // Called from index.htm
...
static const WEBS_CGI _aCGI[] = {
  ...
  {"GetDropdown"           , _callback_ExecGetDropdown       },
  {"GetSamples"            , _callback_ExecGetSamples        },  // Called from Samples.htm
  {"GetIPAddr"             , _callback_ExecGetIPAddr         },
  {"GetOSInfo"             , _callback_ExecGetOSInfo         },
  {"GetIPAddrInfo"         , _callback_ExecGetIPAddrInfo     },
  ...
  {"GetConfigMenuItem"     , _callback_ExecGetConfigMenuItem },
#if INCLUDE_IP_CONFIG_SAMPLE
  {"AssignIPv4ConfigType"  , _callback_IPv4ConfigType        },
...
void WebsSample_SendPageHeader(WEBS_OUTPUT* pOutput, const char* sName) {
  WEBS_USE_PARA(sName);
  IP_WEBS_SendString(pOutput, "<!DOCTYPE html><html lang=\"en\">");
  IP_WEBS_SendString(pOutput, "<head>");
  IP_WEBS_SendString(pOutput, "<meta charset=\"utf-8\">");
  IP_WEBS_SendString(pOutput, "<meta name=\"viewport\" content=\"width=device-width, initial-scale=1, shrink-to-fit=no\">");
  IP_WEBS_SendString(pOutput, "<meta name=\"description\" content=\"\">");
  IP_WEBS_SendString(pOutput, "<meta name=\"author\" content=\"\">");
  IP_WEBS_SendString(pOutput, "<link rel=\"icon\" href=\"favicon.ico\">");
  IP_WEBS_SendString(pOutput, "<title>SEGGER Webserver demo</title>");
  IP_WEBS_SendString(pOutput, "<link href=\"css/bootstrap_min_css.css\" rel=\"stylesheet\">");
  IP_WEBS_SendString(pOutput, "<link href=\"Custom.css\" rel=\"stylesheet\">");
  IP_WEBS_SendString(pOutput, "</head>");
  IP_WEBS_SendString(pOutput, "<body>");
  IP_WEBS_SendString(pOutput, "<div class=\"container\">");
  IP_WEBS_SendString(pOutput, "<nav class=\"navbar navbar-light bg-faded rounded navbar-toggleable-md\" id=\"navigation\">");
  IP_WEBS_SendString(pOutput, "<button class=\"navbar-toggler navbar-toggler-right\" type=\"button\" data-toggle=\"collapse\" data-target=\"#containerNavbar\" aria-controls=\"containerNavbar\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">");
  IP_WEBS_SendString(pOutput, "<span class=\"navbar-toggler-icon\"></span>");
  IP_WEBS_SendString(pOutput, "</button>");
  IP_WEBS_SendString(pOutput, "<span class=\"navbar-brand\" id=\"brand\">emWeb |</span>");
  IP_WEBS_SendString(pOutput, "<div class=\"collapse navbar-collapse\" id=\"containerNavbar\">");
  IP_WEBS_SendString(pOutput, "<ul class=\"navbar-nav mr-auto\" id=\"navList\">");
  IP_WEBS_SendString(pOutput, "<li class=\"nav-item active\">");
  IP_WEBS_SendString(pOutput, "<a class=\"nav-link\" href=\"index.htm\">Home <span class=\"sr-only\">(current)</span></a>");
  IP_WEBS_SendString(pOutput, "</li>");
#if INCLUDE_IP_CONFIG_SAMPLE
  IP_WEBS_SendString(pOutput, "<li class=\"nav-item\">");
  IP_WEBS_SendString(pOutput, "<a class=\"nav-link\" href=\"/IPConfig.htm\">Config</a>");
  IP_WEBS_SendString(pOutput, "</li>");
#endif
  IP_WEBS_SendString(pOutput, "<li class=\"nav-item dropdown\">");
  _callback_ExecGetDropdown(pOutput, NULL, NULL);
  IP_WEBS_SendString(pOutput, "</li>");
  IP_WEBS_SendString(pOutput, "</ul>");
  IP_WEBS_SendString(pOutput, "<div class=\"navbar-text\" id=\"LOG_SysUptime\"></div>");
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "</nav>");
  IP_WEBS_SendString(pOutput, "<div class=\"jumbotron jumbotron-fluid\" id=\"contentMain\">");
  IP_WEBS_SendString(pOutput, "<div class=\"row\" id=\"row01\">");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-4 mx-auto\" id=\"prodLogo\">");
  IP_WEBS_SendString(pOutput, "<img src=\"emWeb_Logo.png\" class=\"img-responsive\" alt=\"emWeb product logo\">");
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-8\">");
}
...
void WebsSample_SendPageFooter(WEBS_OUTPUT* pOutput) {
  IP_WEBS_SendString(pOutput, "</div> <!-- col-sm-8 -->");
  IP_WEBS_SendString(pOutput, "</div>  <!-- row01 -->");
  IP_WEBS_SendString(pOutput, "<script>");
  IP_WEBS_SendString(pOutput, "if(typeof(EventSource) !== \"undefined\") {");
  IP_WEBS_SendString(pOutput, "var conn = new EventSource(\"MaintenanceInfo.cgi\");");
  IP_WEBS_SendString(pOutput, "function _ShowSSEUpdates(event) {");
  IP_WEBS_SendString(pOutput, "document.getElementById(\"LOG_SSEUpdates\").innerHTML = event.data;");
  IP_WEBS_SendString(pOutput, "};");
  IP_WEBS_SendString(pOutput, "function _ShowSysUptime(event) {");
  IP_WEBS_SendString(pOutput, "document.getElementById(\"LOG_SysUptime\").innerHTML = event.data;");
  IP_WEBS_SendString(pOutput, "};");
  IP_WEBS_SendString(pOutput, "conn.addEventListener('LOG_SSEUpdates',     _ShowSSEUpdates);");
  IP_WEBS_SendString(pOutput, "conn.addEventListener('LOG_SysUptime',      _ShowSysUptime);");
  IP_WEBS_SendString(pOutput, "} else {");
  IP_WEBS_SendString(pOutput, "document.getElementById(\"LOG_ConnectionInfo\").innerHTML = \"Sorry, your browser does not support Server-Sent Events (SSE)...\";");
  IP_WEBS_SendString(pOutput, "}");
  IP_WEBS_SendString(pOutput, "</script>");
  IP_WEBS_SendString(pOutput, "<div class=\"row\">");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-6\" id=\"footer\">");
  IP_WEBS_SendString(pOutput, "<img src=\"Logo.gif\"  class=\"img-responsive\" alt=\"SEGGER company logo\">");
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "<div class=\"col-sm-6 text-right\" id=\"footer\">");
  _callback_ExecCounter(pOutput, NULL, NULL);
  IP_WEBS_SendString(pOutput, "<br><span class=\"hint\" id=\"LOG_SSEUpdates\"></span>");
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "</div>");
  IP_WEBS_SendString(pOutput, "<script src=\"js/jquery_min_js.js\"></script>");
  IP_WEBS_SendString(pOutput, "<script>window.jQuery || document.write('<script src=\"js/jquery_min_js.js\"><\\/script>')</script>");
  IP_WEBS_SendString(pOutput, "<script src=\"js/tether_min_js.js\"></script>");
  IP_WEBS_SendString(pOutput, "<script src=\"js/bootstrap_min_js.js\"></script>");
  IP_WEBS_SendString(pOutput, "</body>");
  IP_WEBS_SendString(pOutput, "</html>");
}
...
void IP_WEBS_X_SampleConfig(void) {
  ...
  // Add gzip support
  //
  IP_WEBS_ConfigFindGZipFiles(".gz", 0);
#if WEBS_USE_AUTH_DIGEST
  //
