...
if exist "JLink.exe" (
  JLink.exe -device "%_DEVICE_%" -CommanderScript CommandFile_OS_StartLEDBlink.jlink
  goto END
) else (
...
%_JLINKEXE% -device "%_DEVICE_%" -CommanderScript CommandFile_OS_StartLEDBlink.jlink
