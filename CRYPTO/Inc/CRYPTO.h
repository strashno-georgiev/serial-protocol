...
*/
#define CRYPTO_VERSION            23800   // Format is "Mmmrr" so, for example, 12304 corresponds to version 1.23d.
...
#define CRYPTO_ERROR_BAD_VALID_DATES          -435
#define CRYPTO_ERROR_CANNOT_SIGN              -436     // Certificate can't be used to sign
#define CRYPTO_ERROR_PATH_LENGTH_EXCEEDED     -437     // Too many intermediate CAs
#define CRYPTO_ERROR_BASE64_DECODE_ERROR      -438
...
#define CRYPTO_BLAKE2S_DIGEST_UNIT_COUNT      8
#define CRYPTO_BLAKE2S_DIGEST_BYTE_COUNT      32
#define CRYPTO_BLAKE2S_DIGEST_BIT_COUNT       (CRYPTO_BLAKE2S_DIGEST_BYTE_COUNT*8)
...
#define CRYPTO_BLAKE2B_DIGEST_UNIT_COUNT      8
#define CRYPTO_BLAKE2B_DIGEST_BYTE_COUNT      64
#define CRYPTO_BLAKE2B_DIGEST_BIT_COUNT       (CRYPTO_BLAKE2B_DIGEST_BYTE_COUNT*8)
...
*       Michael [802.11]
*/
#define CRYPTO_MICHAEL_BLOCK_SIZE             4
#define CRYPTO_MICHAEL_KEY_SIZE               8
#define CRYPTO_MICHAEL_MAC_BYTE_COUNT         8
...
*       IDEA
*/
#define CRYPTO_IDEA_BLOCK_SIZE                 8      // Size of one IDEA block, in bytes
#define CRYPTO_IDEA_KEY_SIZE                  16      // Size of one IDEA key, in bytes
...
*       PRESENT
*/
#define CRYPTO_PRESENT_BLOCK_SIZE              8      // Size of one PRESENT block, in bytes
#define CRYPTO_PRESENT80_KEY_SIZE             10      // Size of one PRESENT-80 key, in bytes
#define CRYPTO_PRESENT128_KEY_SIZE            24      // Size of one PRESENT-128 key, in bytes
...
#define CRYPTO_CMAC_IDEA_MAC_SIZE          CRYPTO_IDEA_BLOCK_SIZE
#define CRYPTO_CMAC_PRESENT_MAC_SIZE       CRYPTO_PRESENT_BLOCK_SIZE
...
#define CRYPTO_MICHAEL_MAC_SIZE            8
...
typedef struct {
  ...
  void                      (*pfInitEx)  (void *pContext, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
  void                      (*pfAdd)     (void *pContext, const U8 *pInput, unsigned InputLen);
...
typedef struct {
  const CRYPTO_CIPHER_API *pAPI;  // Pointer to cipher implementation
  U16  aK[6*8+4];                 // Key schedule, 8 rounds
} CRYPTO_IDEA_CONTEXT;
...
typedef struct {
  const CRYPTO_CIPHER_API *pAPI;
  U64 aRoundKey[32];   // Key schedule
} CRYPTO_PRESENT_CONTEXT;
...
typedef struct {
  const CRYPTO_HASH_API * pAPI;                                     // Hash API for this context
  union {                                                           // Intermediate hash
    U32                   aUnit[CRYPTO_BLAKE2S_DIGEST_UNIT_COUNT];
    U8                    aByte[CRYPTO_BLAKE2S_DIGEST_BYTE_COUNT];
  } H;
  U64                     ByteCnt;                                  // Number of hashed bytes
  unsigned                DigestLen;
  CRYPTO_HASH_BUFFER      Block;                                    // Buffered data for block
  U8                      aBlockData[CRYPTO_BLAKE2S_BLOCK_BYTE_COUNT];
...
typedef struct {
  const CRYPTO_HASH_API * pAPI;                                     // Hash API for this context
  union {                                                           // Intermediate hash
    U64                   aUnit[CRYPTO_BLAKE2B_DIGEST_UNIT_COUNT];
    U8                    aByte[CRYPTO_BLAKE2B_DIGEST_BYTE_COUNT];
  } H;
  U64                     ByteCnt;                                  // Number of hashed bytes
  unsigned                DigestLen;
  CRYPTO_HASH_BUFFER      Block;                                    // Buffered data for block
  U8                      aBlockData[CRYPTO_BLAKE2B_BLOCK_BYTE_COUNT];
} CRYPTO_BLAKE2B_CONTEXT;
...
*/
typedef struct {
  U8                  aMAC      [CRYPTO_IDEA_BLOCK_SIZE];
  U8                  aK1       [CRYPTO_IDEA_BLOCK_SIZE];
  U8                  aK2       [CRYPTO_IDEA_BLOCK_SIZE];
  U8                  aBlockData[CRYPTO_IDEA_BLOCK_SIZE];
  CRYPTO_HASH_BUFFER  Block;
  CRYPTO_IDEA_CONTEXT CipherContext;
} CRYPTO_CMAC_IDEA_CONTEXT;
...
*/
typedef struct {
  U8                  aMAC      [CRYPTO_PRESENT_BLOCK_SIZE];
  U8                  aK1       [CRYPTO_PRESENT_BLOCK_SIZE];
  U8                  aK2       [CRYPTO_PRESENT_BLOCK_SIZE];
  U8                  aBlockData[CRYPTO_PRESENT_BLOCK_SIZE];
  CRYPTO_HASH_BUFFER  Block;
  CRYPTO_PRESENT_CONTEXT CipherContext;
} CRYPTO_CMAC_PRESENT_CONTEXT;
...
typedef int (*CRYPTO_MPI_COMBA_MUL_FUNC)(CRYPTO_MPI_LIMB *, CRYPTO_MPI_LIMB *, CRYPTO_MPI_LIMB *, CRYPTO_MEM_CONTEXT*);
...
typedef struct {
  ...
  //
  // Relative order of each entry in a DN.
  //
  unsigned char CountryNamePos;
  unsigned char StateOrProvinceNamePos;
  unsigned char LocalityNamePos;
  unsigned char OrganizationNamePos;
  unsigned char OrganizationalUnitNamePos;
  unsigned char CommonNamePos;
} CRYPTO_X509_NAME_DATA;
...
typedef struct {
  ...
  unsigned                    KeyUsageCritical;     // Key usage is marked Critical
  unsigned                    KeyUsage;             // Key usage from id-ce-keyUsage extension (0 if absent)
  unsigned                    ExtKeyUsageCritical;  // Extended key usage is marked Critical
  ...
  long                        PathLenConstraint;    // Path length constraint from id-ce-basicConstraints (negative if absent)
...
typedef struct {
  ...
  int                            IntermediatePathLen;   // Number of intermediate CA certificates in the path
  int                            PathLen;               // Number of certificates in the path
  U64                            Date;
...
/*********************************************************************
*
*       CRYPTO_X509_EXTENSION_CALLBACK_FUNC
*
*  Description
*    Callback for X.509 certificate extensions.
*/
...
*       X.509 SAN choices
*/
#define CRYPTO_X509_SAN_OTHER_NAME                       0
#define CRYPTO_X509_SAN_RFC822_NAME                      1
#define CRYPTO_X509_SAN_DNS_NAME                         2
#define CRYPTO_X509_SAN_X400_ADDRESS                     3
#define CRYPTO_X509_SAN_DIRECTORY_NAME                   4
#define CRYPTO_X509_SAN_EDI_PARTY_NAME                   5
#define CRYPTO_X509_SAN_UNIFORM_RESOURCE_IDENTIFIER      6
#define CRYPTO_X509_SAN_IP_ADDRESS                       7
#define CRYPTO_X509_SAN_REGISTERED_ID                    8
...
*       Synonyms.
*/
#define CRYPTO_EC_CURVE_P192  CRYPTO_EC_CURVE_secp192r1       /*emDoc ignore*/
#define CRYPTO_EC_CURVE_P224  CRYPTO_EC_CURVE_secp224r1       /*emDoc ignore*/
#define CRYPTO_EC_CURVE_P256  CRYPTO_EC_CURVE_secp256r1       /*emDoc ignore*/
#define CRYPTO_EC_CURVE_P384  CRYPTO_EC_CURVE_secp384r1       /*emDoc ignore*/
#define CRYPTO_EC_CURVE_P521  CRYPTO_EC_CURVE_secp521r1       /*emDoc ignore*/
...
extern const CRYPTO_RNG_API CRYPTO_RNG_HW_SAMA5D2_TRNG;            // SAMA5D2 TRNG as source
extern const CRYPTO_RNG_API CRYPTO_RNG_HW_SAMA5D3_TRNG;            // SAMA5D3 TRNG as source
...
extern const CRYPTO_HASH_API CRYPTO_HASH_BLAKE2S;                      // BLAKE2s in hardware (if available) else software
extern const CRYPTO_HASH_API CRYPTO_HASH_BLAKE2S_SW;                   // BLAKE2s in software
extern const CRYPTO_HASH_API CRYPTO_HASH_BLAKE2B;                      // BLAKE2b in hardware (if available) else software
extern const CRYPTO_HASH_API CRYPTO_HASH_BLAKE2B_SW;                   // BLAKE2b in software
...
extern const CRYPTO_HASH_API CRYPTO_HASH_MD5SHA1;                      // MD5+SHA1 for TLS
...
extern const CRYPTO_MAC_API CRYPTO_MAC_CMAC_IDEA;                      // CMAC-IDEA in hardware (if available) else software
extern const CRYPTO_MAC_API CRYPTO_MAC_CMAC_PRESENT;                   // CMAC-PRESENT in hardware (if available) else software
...
extern const CRYPTO_MAC_API CRYPTO_MAC_POLY1305_AES;                   // Poly1305-AES in hardware (if available) else software
extern const CRYPTO_MAC_API CRYPTO_MAC_POLY1305_ARIA;                  // Poly1305-ARIA in hardware (if available) else software
extern const CRYPTO_MAC_API CRYPTO_MAC_POLY1305_SEED;                  // Poly1305-SEED in hardware (if available) else software
extern const CRYPTO_MAC_API CRYPTO_MAC_POLY1305_CAMELLIA;              // Poly1305-Camellia in hardware (if available) else software
extern const CRYPTO_MAC_API CRYPTO_MAC_POLY1305_TWOFISH;               // Poly1305-Twofish in hardware (if available) else software
extern const CRYPTO_MAC_API CRYPTO_MAC_MICHAEL;                        // Michael in software
extern const CRYPTO_MAC_API CRYPTO_MAC_XCBC_AES;                       // XCBC-AES
extern const CRYPTO_MAC_API CRYPTO_MAC_XCBC_ARIA;                      // XCBC-ARIA
extern const CRYPTO_MAC_API CRYPTO_MAC_XCBC_SEED;                      // XCBC-SEED
extern const CRYPTO_MAC_API CRYPTO_MAC_XCBC_CAMELLIA;                  // XCBC-CAMELLIA
extern const CRYPTO_MAC_API CRYPTO_MAC_XCBC_TWOFISH;                   // XCBC-TWOFISH
...
extern const CRYPTO_CIPHER_API CRYPTO_CIPHER_IDEA;                     // IDEA in hardware (if available) else software
extern const CRYPTO_CIPHER_API CRYPTO_CIPHER_IDEA_SW;                  // IDEA in software
...
extern const CRYPTO_CIPHER_API CRYPTO_CIPHER_PRESENT;                  // PRESENT in hardware (if available) else software
extern const CRYPTO_CIPHER_API CRYPTO_CIPHER_PRESENT_SW;               // PRESENT in software

/*********************************************************************
*
*       Legacy names
*/
#define CRYPTO_CIPHER_AES_HW_STM32_CRYP2  CRYPTO_CIPHER_AES_HW_STM32_CRYP  /*emDoc ignore*/
#define CRYPTO_CIPHER_TDES_HW_STM32_CRYP2 CRYPTO_CIPHER_TDES_HW_STM32_CRYP /*emDoc ignore*/
...
/*********************************************************************
*
*       Generic BLAKE2s functions that conform to the HASH API.
*/
void     CRYPTO_HASH_BLAKE2S_Init                   (void *pSelf);
void     CRYPTO_HASH_BLAKE2S_Add                    (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_HASH_BLAKE2S_Get                    (void *pSelf, U8 *pDigest, unsigned DigestLen);
void     CRYPTO_HASH_BLAKE2S_Final                  (void *pSelf, U8 *pDigest, unsigned DigestLen);
void     CRYPTO_HASH_BLAKE2S_Kill                   (void *pSelf);

/*********************************************************************
*
*       Generic BLAKE2b functions that conform to the HASH API.
*/
void     CRYPTO_HASH_BLAKE2B_Init                   (void *pSelf);
void     CRYPTO_HASH_BLAKE2B_Add                    (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_HASH_BLAKE2B_Get                    (void *pSelf, U8 *pDigest, unsigned DigestLen);
void     CRYPTO_HASH_BLAKE2B_Final                  (void *pSelf, U8 *pDigest, unsigned DigestLen);
void     CRYPTO_HASH_BLAKE2B_Kill                   (void *pSelf);
...
*       BLAKE2s functions
*/
void     CRYPTO_BLAKE2S_Calc                        (U8 *pOutput, unsigned OutputLen, const U8 *pInput, unsigned InputLen);
void     CRYPTO_BLAKE2S_Calc_256                    (U8 *pOutput,                     const U8 *pInput, unsigned InputLen);
void     CRYPTO_BLAKE2S_Init                        (CRYPTO_BLAKE2S_CONTEXT *pSelf);
void     CRYPTO_BLAKE2S_InitEx                      (CRYPTO_BLAKE2S_CONTEXT *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_BLAKE2S_Add                         (CRYPTO_BLAKE2S_CONTEXT *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_BLAKE2S_Get                         (CRYPTO_BLAKE2S_CONTEXT *pSelf, U8 *pDigest, unsigned DigestLen);
void     CRYPTO_BLAKE2S_Final                       (CRYPTO_BLAKE2S_CONTEXT *pSelf, U8 *pDigest, unsigned DigestLen);
void     CRYPTO_BLAKE2S_Final_256                   (CRYPTO_BLAKE2S_CONTEXT *pSelf, U8 *pDigest);
void     CRYPTO_BLAKE2S_Kill                        (CRYPTO_BLAKE2S_CONTEXT *pSelf);
void     CRYPTO_BLAKE2S_Install                     (const CRYPTO_HASH_API *pHWAPI, const CRYPTO_HASH_API *pSWAPI);
void     CRYPTO_BLAKE2S_QueryInstall                (const CRYPTO_HASH_API **ppHWAPI, const CRYPTO_HASH_API **ppSWAPI);
...
*       BLAKE2b functions
*/
void     CRYPTO_BLAKE2B_Calc                        (U8 *pOutput, unsigned OutputLen, const U8 *pInput, unsigned InputLen);
void     CRYPTO_BLAKE2B_Calc_512                    (U8 *pOutput,                     const U8 *pInput, unsigned InputLen);
void     CRYPTO_BLAKE2B_Init                        (CRYPTO_BLAKE2B_CONTEXT *pSelf);
void     CRYPTO_BLAKE2B_InitEx                      (CRYPTO_BLAKE2B_CONTEXT *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_BLAKE2B_Add                         (CRYPTO_BLAKE2B_CONTEXT *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_BLAKE2B_Get                         (CRYPTO_BLAKE2B_CONTEXT *pSelf, U8 *pDigest, unsigned DigestLen);
void     CRYPTO_BLAKE2B_Final                       (CRYPTO_BLAKE2B_CONTEXT *pSelf, U8 *pDigest, unsigned DigestLen);
void     CRYPTO_BLAKE2B_Final_512                   (CRYPTO_BLAKE2B_CONTEXT *pSelf, U8 *pDigest);
void     CRYPTO_BLAKE2B_Kill                        (CRYPTO_BLAKE2B_CONTEXT *pSelf);
void     CRYPTO_BLAKE2B_Install                     (const CRYPTO_HASH_API *pHWAPI, const CRYPTO_HASH_API *pSWAPI);
void     CRYPTO_BLAKE2B_QueryInstall                (const CRYPTO_HASH_API **ppHWAPI, const CRYPTO_HASH_API **ppSWAPI);
...
void     CRYPTO_CMAC_AES_Final                      (CRYPTO_CMAC_AES_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_CMAC_AES_Final_128                  (CRYPTO_CMAC_AES_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_CMAC_TDES_Final                     (CRYPTO_CMAC_TDES_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_CMAC_TDES_Final_64                  (CRYPTO_CMAC_TDES_CONTEXT *pSelf, U8 *pOutput);
...
*       CMAC-IDEA functions
*/
void     CRYPTO_CMAC_IDEA_Calc                      (U8 *pOutput, unsigned OutputLen, const U8 *pKey, unsigned KeyLen, const U8 *pInput, unsigned InputLen);
void     CRYPTO_CMAC_IDEA_Calc_64                   (U8 *pOutput,                     const U8 *pKey, unsigned KeyLen, const U8 *pInput, unsigned InputLen);
void     CRYPTO_CMAC_IDEA_Init                      (CRYPTO_CMAC_IDEA_CONTEXT *pSelf, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_CMAC_IDEA_InitEx                    (CRYPTO_CMAC_IDEA_CONTEXT *pSelf, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_CMAC_IDEA_Add                       (CRYPTO_CMAC_IDEA_CONTEXT *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_CMAC_IDEA_Final                     (CRYPTO_CMAC_IDEA_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_CMAC_IDEA_Final_64                  (CRYPTO_CMAC_IDEA_CONTEXT *pSelf, U8 *pOutput);
void     CRYPTO_CMAC_IDEA_Kill                      (CRYPTO_CMAC_IDEA_CONTEXT *pSelf);

/*********************************************************************
*
*       CMAC-PRESENT functions
*/
void     CRYPTO_CMAC_PRESENT_Calc                   (U8 *pOutput, unsigned OutputLen, const U8 *pKey, unsigned KeyLen, const U8 *pInput, unsigned InputLen);
void     CRYPTO_CMAC_PRESENT_Calc_64                (U8 *pOutput,                     const U8 *pKey, unsigned KeyLen, const U8 *pInput, unsigned InputLen);
void     CRYPTO_CMAC_PRESENT_Init                   (CRYPTO_CMAC_PRESENT_CONTEXT *pSelf, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_CMAC_PRESENT_InitEx                 (CRYPTO_CMAC_PRESENT_CONTEXT *pSelf, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_CMAC_PRESENT_Add                    (CRYPTO_CMAC_PRESENT_CONTEXT *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_CMAC_PRESENT_Final                  (CRYPTO_CMAC_PRESENT_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_CMAC_PRESENT_Final_64               (CRYPTO_CMAC_PRESENT_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_CMAC_ARIA_Final                     (CRYPTO_CMAC_ARIA_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_CMAC_ARIA_Final_128                 (CRYPTO_CMAC_ARIA_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_CMAC_SEED_Final                     (CRYPTO_CMAC_SEED_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_CMAC_SEED_Final_128                 (CRYPTO_CMAC_SEED_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_CMAC_CAMELLIA_Final                 (CRYPTO_CMAC_CAMELLIA_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_CMAC_CAMELLIA_Final_128             (CRYPTO_CMAC_CAMELLIA_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_CMAC_TWOFISH_Final                  (CRYPTO_CMAC_TWOFISH_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_CMAC_TWOFISH_Final_128              (CRYPTO_CMAC_TWOFISH_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_CMAC_BLOWFISH_Final                 (CRYPTO_CMAC_BLOWFISH_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_CMAC_BLOWFISH_Final_64              (CRYPTO_CMAC_BLOWFISH_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_CMAC_CAST_Final                     (CRYPTO_CMAC_CAST_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_CMAC_CAST_Final_64                  (CRYPTO_CMAC_CAST_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_GMAC_AES_Final                      (CRYPTO_GMAC_AES_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_GMAC_AES_Final_128                  (CRYPTO_GMAC_AES_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_GMAC_ARIA_Final                     (CRYPTO_GMAC_ARIA_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_GMAC_ARIA_Final_128                 (CRYPTO_GMAC_ARIA_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_GMAC_SEED_Final                     (CRYPTO_GMAC_SEED_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_GMAC_SEED_Final_128                 (CRYPTO_GMAC_SEED_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_GMAC_CAMELLIA_Final                 (CRYPTO_GMAC_CAMELLIA_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_GMAC_CAMELLIA_Final_128             (CRYPTO_GMAC_CAMELLIA_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_GMAC_TWOFISH_Final                  (CRYPTO_GMAC_TWOFISH_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_GMAC_TWOFISH_Final_128              (CRYPTO_GMAC_TWOFISH_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_XCBC_AES_Final                      (CRYPTO_XCBC_AES_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_XCBC_AES_Final_96                   (CRYPTO_XCBC_AES_CONTEXT *pSelf, U8 *pOutput);
void     CRYPTO_XCBC_AES_Final_128                  (CRYPTO_XCBC_AES_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_XCBC_CAMELLIA_Final                 (CRYPTO_XCBC_CAMELLIA_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_XCBC_CAMELLIA_Final_96              (CRYPTO_XCBC_CAMELLIA_CONTEXT *pSelf, U8 *pOutput);
void     CRYPTO_XCBC_CAMELLIA_Final_128             (CRYPTO_XCBC_CAMELLIA_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_XCBC_ARIA_Final                     (CRYPTO_XCBC_ARIA_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_XCBC_ARIA_Final_96                  (CRYPTO_XCBC_ARIA_CONTEXT *pSelf, U8 *pOutput);
void     CRYPTO_XCBC_ARIA_Final_128                 (CRYPTO_XCBC_ARIA_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_XCBC_SEED_Final                     (CRYPTO_XCBC_SEED_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_XCBC_SEED_Final_96                  (CRYPTO_XCBC_SEED_CONTEXT *pSelf, U8 *pOutput);
void     CRYPTO_XCBC_SEED_Final_128                 (CRYPTO_XCBC_SEED_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_XCBC_TWOFISH_Final                  (CRYPTO_XCBC_TWOFISH_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_XCBC_TWOFISH_Final_96               (CRYPTO_XCBC_TWOFISH_CONTEXT *pSelf, U8 *pOutput);
void     CRYPTO_XCBC_TWOFISH_Final_128              (CRYPTO_XCBC_TWOFISH_CONTEXT *pSelf, U8 *pOutput);
...
void     CRYPTO_POLY1305_Final                      (CRYPTO_POLY1305_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_POLY1305_Final_128                  (CRYPTO_POLY1305_CONTEXT *pSelf, U8 *pOutput);
...
*       Michael functions
*/
void     CRYPTO_MICHAEL_Init                        (CRYPTO_MICHAEL_CONTEXT *pSelf, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_MICHAEL_Init_64                     (CRYPTO_MICHAEL_CONTEXT *pSelf, const U8 *pKey);
void     CRYPTO_MICHAEL_InitEx                      (CRYPTO_MICHAEL_CONTEXT *pSelf, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MICHAEL_Add                         (CRYPTO_MICHAEL_CONTEXT *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MICHAEL_Final                       (CRYPTO_MICHAEL_CONTEXT *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MICHAEL_Final_64                    (CRYPTO_MICHAEL_CONTEXT *pSelf, U8 *pOutput);
void     CRYPTO_MICHAEL_Kill                        (CRYPTO_MICHAEL_CONTEXT *pSelf);
void     CRYPTO_MICHAEL_Calc                        (U8 *pOutput, unsigned OutputLen, const U8 *pKey, unsigned KeyLen, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MICHAEL_Calc_64                     (U8 *pOutput,                     const U8 *pKey, unsigned KeyLen, const U8 *pInput, unsigned InputLen);
...
void     CRYPTO_MAC_HMAC_SHA1_InitEx                (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
...
void     CRYPTO_MAC_HMAC_SHA224_InitEx              (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
...
void     CRYPTO_MAC_HMAC_SHA256_InitEx              (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
...
void     CRYPTO_MAC_HMAC_SHA384_InitEx              (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
...
void     CRYPTO_MAC_HMAC_SHA512_InitEx              (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
...
void     CRYPTO_MAC_HMAC_SHA512_224_InitEx          (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
...
void     CRYPTO_MAC_HMAC_SHA512_256_InitEx          (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
...
void     CRYPTO_MAC_HMAC_SHA3_224_InitEx            (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
...
void     CRYPTO_MAC_HMAC_SHA3_256_InitEx            (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
...
void     CRYPTO_MAC_HMAC_SHA3_384_InitEx            (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
...
void     CRYPTO_MAC_HMAC_SHA3_512_InitEx            (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
...
void     CRYPTO_MAC_HMAC_SM3_InitEx                 (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
...
void     CRYPTO_MAC_HMAC_MD5_InitEx                 (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
...
void     CRYPTO_MAC_HMAC_RIPEMD160_InitEx           (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
...
void     CRYPTO_MAC_CMAC_AES_InitEx                 (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_CMAC_AES_Add                    (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_CMAC_AES_Final                  (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_CMAC_AES_Final_128              (void *pSelf, U8 *pOutput);
...
void     CRYPTO_MAC_CMAC_TDES_InitEx                (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_CMAC_TDES_Add                   (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_CMAC_TDES_Final                 (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_CMAC_TDES_Final_64              (void *pSelf, U8 *pOutput);
void     CRYPTO_MAC_CMAC_TDES_Kill                  (void *pSelf);

/*********************************************************************
*
*       Generic IDEA-CMAC functions
*/
void     CRYPTO_MAC_CMAC_IDEA_Init                  (void *pSelf, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_MAC_CMAC_IDEA_InitEx                (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_CMAC_IDEA_Add                   (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_CMAC_IDEA_Final                 (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_CMAC_IDEA_Final_64              (void *pSelf, U8 *pOutput);
void     CRYPTO_MAC_CMAC_IDEA_Kill                  (void *pSelf);

/*********************************************************************
*
*       Generic PRESENT-CMAC functions
*/
void     CRYPTO_MAC_CMAC_PRESENT_Init               (void *pSelf, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_MAC_CMAC_PRESENT_InitEx             (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_CMAC_PRESENT_Add                (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_CMAC_PRESENT_Final              (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_CMAC_PRESENT_Final_64           (void *pSelf, U8 *pOutput);
void     CRYPTO_MAC_CMAC_PRESENT_Kill               (void *pSelf);
...
void     CRYPTO_MAC_CMAC_ARIA_InitEx                (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_CMAC_ARIA_Add                   (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_CMAC_ARIA_Final                 (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_CMAC_ARIA_Final_128             (void *pSelf, U8 *pOutput);
...
void     CRYPTO_MAC_CMAC_SEED_InitEx                (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_CMAC_SEED_Add                   (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_CMAC_SEED_Final                 (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_CMAC_SEED_Final_128             (void *pSelf, U8 *pOutput);
...
void     CRYPTO_MAC_CMAC_CAMELLIA_InitEx            (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_CMAC_CAMELLIA_Add               (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_CMAC_CAMELLIA_Final             (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_CMAC_CAMELLIA_Final_128         (void *pSelf, U8 *pOutput);
...
void     CRYPTO_MAC_CMAC_TWOFISH_InitEx             (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_CMAC_TWOFISH_Add                (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_CMAC_TWOFISH_Final              (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_CMAC_TWOFISH_Final_128          (void *pSelf, U8 *pOutput);
...
void     CRYPTO_MAC_CMAC_BLOWFISH_InitEx            (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_CMAC_BLOWFISH_Add               (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_CMAC_BLOWFISH_Final             (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_CMAC_BLOWFISH_Final_64          (void *pSelf, U8 *pOutput);
...
void     CRYPTO_MAC_CMAC_CAST_InitEx                (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_CMAC_CAST_Add                   (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_CMAC_CAST_Final                 (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_CMAC_CAST_Final_64              (void *pSelf, U8 *pOutput);
...
*/
void     CRYPTO_MAC_GMAC_AES_InitEx                 (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_GMAC_AES_Add                    (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_GMAC_AES_Final                  (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_GMAC_AES_Final_128              (void *pSelf, U8 *pOutput);
...
*/
void     CRYPTO_MAC_GMAC_ARIA_InitEx                (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_GMAC_ARIA_Add                   (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_GMAC_ARIA_Final                 (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_GMAC_ARIA_Final_128             (void *pSelf, U8 *pOutput);
...
*/
void     CRYPTO_MAC_GMAC_SEED_InitEx                (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_GMAC_SEED_Add                   (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_GMAC_SEED_Final                 (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_GMAC_SEED_Final_128             (void *pSelf, U8 *pOutput);
...
*/
void     CRYPTO_MAC_GMAC_CAMELLIA_InitEx            (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_GMAC_CAMELLIA_Add               (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_GMAC_CAMELLIA_Final             (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_GMAC_CAMELLIA_Final_128         (void *pSelf, U8 *pOutput);
...
*/
void     CRYPTO_MAC_GMAC_TWOFISH_InitEx             (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_GMAC_TWOFISH_Add                (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_GMAC_TWOFISH_Final              (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_GMAC_TWOFISH_Final_128          (void *pSelf, U8 *pOutput);
...
void     CRYPTO_MAC_XCBC_AES_InitEx                 (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_XCBC_AES_Add                    (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_XCBC_AES_Final                  (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_XCBC_AES_Final_128              (void *pSelf, U8 *pOutput);
...
void     CRYPTO_MAC_XCBC_CAMELLIA_InitEx            (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_XCBC_CAMELLIA_Add               (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_XCBC_CAMELLIA_Final             (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_XCBC_CAMELLIA_Final_128         (void *pSelf, U8 *pOutput);
...
void     CRYPTO_MAC_XCBC_ARIA_InitEx                (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_XCBC_ARIA_Add                   (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_XCBC_ARIA_Final                 (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_XCBC_ARIA_Final_128             (void *pSelf, U8 *pOutput);
...
void     CRYPTO_MAC_XCBC_SEED_InitEx                (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_XCBC_SEED_Add                   (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_XCBC_SEED_Final                 (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_XCBC_SEED_Final_128             (void *pSelf, U8 *pOutput);
...
void     CRYPTO_MAC_XCBC_TWOFISH_InitEx             (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_XCBC_TWOFISH_Add                (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_XCBC_TWOFISH_Final              (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_XCBC_TWOFISH_Final_128          (void *pSelf, U8 *pOutput);
...
*/
void     CRYPTO_MAC_POLY1305_AES_InitEx             (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_POLY1305_AES_Add                (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_POLY1305_AES_Final              (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_POLY1305_AES_Final_128          (void *pSelf, U8 *pOutput);
...
*/
void     CRYPTO_MAC_POLY1305_ARIA_InitEx            (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_POLY1305_ARIA_Add               (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_POLY1305_ARIA_Final             (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_POLY1305_ARIA_Final_128         (void *pSelf, U8 *pOutput);
...
*/
void     CRYPTO_MAC_POLY1305_SEED_InitEx            (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_POLY1305_SEED_Add               (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_POLY1305_SEED_Final             (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_POLY1305_SEED_Final_128         (void *pSelf, U8 *pOutput);
...
*/
void     CRYPTO_MAC_POLY1305_CAMELLIA_InitEx        (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_POLY1305_CAMELLIA_Add           (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_POLY1305_CAMELLIA_Final         (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_POLY1305_CAMELLIA_Final_128     (void *pSelf, U8 *pOutput);
...
*/
void     CRYPTO_MAC_POLY1305_TWOFISH_InitEx         (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_POLY1305_TWOFISH_Add            (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_POLY1305_TWOFISH_Final          (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_POLY1305_TWOFISH_Final_128      (void *pSelf, U8 *pOutput);
void     CRYPTO_MAC_POLY1305_TWOFISH_Kill           (void *pSelf);

/*********************************************************************
*
*       Generic Michael functions
*/
void     CRYPTO_MAC_MICHAEL_Init                    (void *pSelf, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_MAC_MICHAEL_InitEx                  (void *pSelf, unsigned DigestLen, const U8 *pKey, unsigned KeyLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_MAC_MICHAEL_Add                     (void *pSelf, const U8 *pInput, unsigned InputLen);
void     CRYPTO_MAC_MICHAEL_Final                   (void *pSelf, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_MAC_MICHAEL_Final_64                (void *pSelf, U8 *pOutput);
void     CRYPTO_MAC_MICHAEL_Kill                    (void *pSelf);
...
void     CRYPTO_KDF1_BLAKE2S_Calc                   (const U8 *pSeed, unsigned SeedLen, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_KDF1_BLAKE2S_CalcEx                 (const U8 *pSeed, unsigned SeedLen, U8 *pOutput, unsigned OutputLen, CRYPTO_LOGIC_OP Operation);
void     CRYPTO_KDF1_BLAKE2B_Calc                   (const U8 *pSeed, unsigned SeedLen, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_KDF1_BLAKE2B_CalcEx                 (const U8 *pSeed, unsigned SeedLen, U8 *pOutput, unsigned OutputLen, CRYPTO_LOGIC_OP Operation);
...
void     CRYPTO_KDF2_BLAKE2S_Calc                   (const U8 *pSeed, unsigned SeedLen, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_KDF2_BLAKE2S_CalcEx                 (const U8 *pSeed, unsigned SeedLen, U8 *pOutput, unsigned OutputLen, CRYPTO_LOGIC_OP Operation);
void     CRYPTO_KDF2_BLAKE2B_Calc                   (const U8 *pSeed, unsigned SeedLen, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_KDF2_BLAKE2B_CalcEx                 (const U8 *pSeed, unsigned SeedLen, U8 *pOutput, unsigned OutputLen, CRYPTO_LOGIC_OP Operation);
...
void     CRYPTO_X9v63_KDF_BLAKE2S_Calc              (const U8 *pSeed, unsigned SeedLen, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_X9v63_KDF_BLAKE2S_CalcEx            (const U8 *pSeed, unsigned SeedLen, const U8 *pShared, unsigned SharedLen, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_X9v63_KDF_BLAKE2B_Calc              (const U8 *pSeed, unsigned SeedLen, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_X9v63_KDF_BLAKE2B_CalcEx            (const U8 *pSeed, unsigned SeedLen, const U8 *pShared, unsigned SharedLen, U8 *pOutput, unsigned OutputLen);
...
void     CRYPTO_HKDF_BLAKE2S_Extract                (const U8 *pInput, unsigned InputLen, const U8 *pSalt, unsigned SaltLen, U8 *pPRK, unsigned PRKLen);
void     CRYPTO_HKDF_BLAKE2S_Expand                 (const U8 *pPRK,   unsigned PRKLen,   const U8 *pInfo, unsigned InfoLen,                                    U8 *pOutput, unsigned OutputLen);
void     CRYPTO_HKDF_BLAKE2S_Calc                   (const U8 *pInput, unsigned InputLen, const U8 *pSalt, unsigned SaltLen, const U8 *pInfo, unsigned InfoLen, U8 *pOutput, unsigned OutputLen);
void     CRYPTO_HKDF_BLAKE2B_Extract                (const U8 *pInput, unsigned InputLen, const U8 *pSalt, unsigned SaltLen, U8 *pPRK, unsigned PRKLen);
void     CRYPTO_HKDF_BLAKE2B_Expand                 (const U8 *pPRK,   unsigned PRKLen,   const U8 *pInfo, unsigned InfoLen,                                    U8 *pOutput, unsigned OutputLen);
void     CRYPTO_HKDF_BLAKE2B_Calc                   (const U8 *pInput, unsigned InputLen, const U8 *pSalt, unsigned SaltLen, const U8 *pInfo, unsigned InfoLen, U8 *pOutput, unsigned OutputLen);
...
*       IDEA functions.
*/
void     CRYPTO_IDEA_InitEncrypt                    (CRYPTO_IDEA_CONTEXT *pSelf, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_IDEA_InitDecrypt                    (CRYPTO_IDEA_CONTEXT *pSelf, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_IDEA_Kill                           (CRYPTO_IDEA_CONTEXT *pSelf);
void     CRYPTO_IDEA_Encrypt                        (CRYPTO_IDEA_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput);
void     CRYPTO_IDEA_Decrypt                        (CRYPTO_IDEA_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput);
void     CRYPTO_IDEA_ECB_Encrypt                    (CRYPTO_IDEA_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned Len);
void     CRYPTO_IDEA_ECB_Decrypt                    (CRYPTO_IDEA_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned Len);
void     CRYPTO_IDEA_CBC_Encrypt                    (CRYPTO_IDEA_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned Len, U8 *pIV);
void     CRYPTO_IDEA_CBC_Decrypt                    (CRYPTO_IDEA_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned Len, U8 *pIV);
void     CRYPTO_IDEA_OFB_Encrypt                    (CRYPTO_IDEA_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned Len, U8 *pIV);
void     CRYPTO_IDEA_OFB_Decrypt                    (CRYPTO_IDEA_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned Len, U8 *pIV);
void     CRYPTO_IDEA_CTR_Encrypt                    (CRYPTO_IDEA_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned Len, U8 *pCTR, unsigned CTRIndex, unsigned CTRLen);
void     CRYPTO_IDEA_CTR_Decrypt                    (CRYPTO_IDEA_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned Len, U8 *pCTR, unsigned CTRIndex, unsigned CTRLen);
void     CRYPTO_IDEA_Install                        (const CRYPTO_CIPHER_API *pHWAPI, const CRYPTO_CIPHER_API *pSWAPI);
void     CRYPTO_IDEA_QueryInstall                   (const CRYPTO_CIPHER_API **ppHWAPI, const CRYPTO_CIPHER_API **ppSWAPI);
...
/*********************************************************************
*
*       PRESENT management functions, user-supplied key size.
*/
void     CRYPTO_PRESENT_InitEncrypt                 (CRYPTO_PRESENT_CONTEXT *pSelf, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_PRESENT_InitDecrypt                 (CRYPTO_PRESENT_CONTEXT *pSelf, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_PRESENT_Kill                        (CRYPTO_PRESENT_CONTEXT *pSelf);
void     CRYPTO_PRESENT_Encrypt                     (CRYPTO_PRESENT_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput);
void     CRYPTO_PRESENT_Decrypt                     (CRYPTO_PRESENT_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput);
void     CRYPTO_PRESENT_ECB_Encrypt                 (CRYPTO_PRESENT_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen);
void     CRYPTO_PRESENT_ECB_Decrypt                 (CRYPTO_PRESENT_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen);
void     CRYPTO_PRESENT_CBC_Encrypt                 (CRYPTO_PRESENT_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pIV);
void     CRYPTO_PRESENT_CBC_Decrypt                 (CRYPTO_PRESENT_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pIV);
void     CRYPTO_PRESENT_OFB_Encrypt                 (CRYPTO_PRESENT_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pIV);
void     CRYPTO_PRESENT_OFB_Decrypt                 (CRYPTO_PRESENT_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pIV);
void     CRYPTO_PRESENT_CTR_Encrypt                 (CRYPTO_PRESENT_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pCTR, unsigned CTRIndex, unsigned CTRLen);
void     CRYPTO_PRESENT_CTR_Decrypt                 (CRYPTO_PRESENT_CONTEXT *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pCTR, unsigned CTRIndex, unsigned CTRLen);
void     CRYPTO_PRESENT_CCM_Encrypt                 (CRYPTO_PRESENT_CONTEXT *pSelf, U8 *pOutput,       U8 *pTag, unsigned TagLen, const U8 *pInput, unsigned InputLen, const U8 *pAAD, unsigned AADLen, const U8 *pIV, unsigned IVLen);
int      CRYPTO_PRESENT_CCM_Decrypt                 (CRYPTO_PRESENT_CONTEXT *pSelf, U8 *pOutput, const U8 *pTag, unsigned TagLen, const U8 *pInput, unsigned InputLen, const U8 *pAAD, unsigned AADLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_PRESENT_GCM_Encrypt                 (CRYPTO_PRESENT_CONTEXT *pSelf, U8 *pOutput,       U8 *pTag, unsigned TagLen, const U8 *pInput, unsigned InputLen, const U8 *pAAD, unsigned AADLen, const U8 *pIV, unsigned IVLen);
int      CRYPTO_PRESENT_GCM_Decrypt                 (CRYPTO_PRESENT_CONTEXT *pSelf, U8 *pOutput, const U8 *pTag, unsigned TagLen, const U8 *pInput, unsigned InputLen, const U8 *pAAD, unsigned AADLen, const U8 *pIV, unsigned IVLen);
void     CRYPTO_PRESENT_Install                     (const CRYPTO_CIPHER_API *pHWAPI, const CRYPTO_CIPHER_API *pSWAPI);
void     CRYPTO_PRESENT_QueryInstall                (const CRYPTO_CIPHER_API **ppHWAPI, const CRYPTO_CIPHER_API **ppSWAPI);
...
/*********************************************************************
*
*       Generic IDEA functions that conform to the CIPHER API.
*/
void     CRYPTO_CIPHER_IDEA_InitEncrypt             (void *pSelf, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_CIPHER_IDEA_InitDecrypt             (void *pSelf, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_CIPHER_IDEA_128_InitEncrypt         (void *pSelf, const U8 *pKey);
void     CRYPTO_CIPHER_IDEA_128_InitDecrypt         (void *pSelf, const U8 *pKey);
void     CRYPTO_CIPHER_IDEA_Encrypt                 (void *pSelf, U8 *pOutput, const U8 *pInput);
void     CRYPTO_CIPHER_IDEA_Decrypt                 (void *pSelf, U8 *pOutput, const U8 *pInput);
void     CRYPTO_CIPHER_IDEA_ECB_Encrypt             (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen);
void     CRYPTO_CIPHER_IDEA_ECB_Decrypt             (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen);
void     CRYPTO_CIPHER_IDEA_CBC_Encrypt             (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pIV);
void     CRYPTO_CIPHER_IDEA_CBC_Decrypt             (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pIV);
void     CRYPTO_CIPHER_IDEA_OFB_Encrypt             (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pIV);
void     CRYPTO_CIPHER_IDEA_OFB_Decrypt             (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pIV);
void     CRYPTO_CIPHER_IDEA_CTR_Encrypt             (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pCTR, unsigned CTRIndex, unsigned CTRLen);
void     CRYPTO_CIPHER_IDEA_CTR_Decrypt             (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pCTR, unsigned CTRIndex, unsigned CTRLen);
void     CRYPTO_CIPHER_IDEA_CTR_0_8_Encrypt         (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pCTR);
void     CRYPTO_CIPHER_IDEA_CTR_0_8_Decrypt         (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pCTR);
void     CRYPTO_CIPHER_IDEA_CTR_4_4_Encrypt         (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pCTR);
void     CRYPTO_CIPHER_IDEA_CTR_4_4_Decrypt         (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pCTR);
...
/*********************************************************************
*
*       Generic PRESENT functions that conform to the CIPHER API.
*/
void     CRYPTO_CIPHER_PRESENT_InitEncrypt          (void *pSelf, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_CIPHER_PRESENT_InitDecrypt          (void *pSelf, const U8 *pKey, unsigned KeyLen);
void     CRYPTO_CIPHER_PRESENT_Encrypt              (void *pSelf, U8 *pOutput, const U8 *pInput);
void     CRYPTO_CIPHER_PRESENT_Decrypt              (void *pSelf, U8 *pOutput, const U8 *pInput);
void     CRYPTO_CIPHER_PRESENT_80_InitEncrypt       (void *pSelf, const U8 *pKey);
void     CRYPTO_CIPHER_PRESENT_80_InitDecrypt       (void *pSelf, const U8 *pKey);
void     CRYPTO_CIPHER_PRESENT_128_InitEncrypt      (void *pSelf, const U8 *pKey);
void     CRYPTO_CIPHER_PRESENT_128_InitDecrypt      (void *pSelf, const U8 *pKey);
void     CRYPTO_CIPHER_PRESENT_ECB_Encrypt          (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen);
void     CRYPTO_CIPHER_PRESENT_ECB_Decrypt          (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen);
void     CRYPTO_CIPHER_PRESENT_CBC_Encrypt          (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pIV);
void     CRYPTO_CIPHER_PRESENT_CBC_Decrypt          (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pIV);
void     CRYPTO_CIPHER_PRESENT_OFB_Encrypt          (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pIV);
void     CRYPTO_CIPHER_PRESENT_OFB_Decrypt          (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pIV);
void     CRYPTO_CIPHER_PRESENT_CTR_Encrypt          (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pCTR, unsigned CTRIndex, unsigned CTRLen);
void     CRYPTO_CIPHER_PRESENT_CTR_Decrypt          (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pCTR, unsigned CTRIndex, unsigned CTRLen);
void     CRYPTO_CIPHER_PRESENT_CTR_0_8_Encrypt      (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pCTR);
void     CRYPTO_CIPHER_PRESENT_CTR_0_8_Decrypt      (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pCTR);
void     CRYPTO_CIPHER_PRESENT_CTR_4_4_Encrypt      (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pCTR);
void     CRYPTO_CIPHER_PRESENT_CTR_4_4_Decrypt      (void *pSelf, U8 *pOutput, const U8 *pInput, unsigned InputLen, U8 *pCTR);
...
int      CRYPTO_EC_X448_BaseMul                     (CRYPTO_MPI *pX, const CRYPTO_MPI *pMultiplier, CRYPTO_MEM_CONTEXT *pMem);
...
int      CRYPTO_X509_CompareDN                      (const CRYPTO_X509_NAME_DATA *pDN1, const CRYPTO_X509_NAME_DATA *pDN2);
...
int      CRYPTO_X509_MatchName                      (const char *sSubjectName, const char *pDNSName, unsigned DNSNameLen);
int      CRYPTO_X509_ValidateSubjectDNSName         (CRYPTO_X509_CERTIFICATE_DATA *pCert, const char *sSubjectName);
int      CRYPTO_X509_ValidateSubjectIPAddr          (CRYPTO_X509_CERTIFICATE_DATA *pCert, const U8 *pIpAddr);
...
*/
int      CRYPTO_MPI_Mul_Comba_112                       (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_128                       (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_160                       (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_192                       (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_224                       (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_256                       (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_384                       (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_448                       (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_512                       (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_544                       (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_768                       (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_1024                      (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_2048                      (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_3072                      (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_Karatsuba_256             (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_Karatsuba_512             (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_Karatsuba_1024            (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
int      CRYPTO_MPI_Mul_Comba_Karatsuba_2048            (CRYPTO_MPI_LIMB *pOutput, CRYPTO_MPI_LIMB *pInputA, CRYPTO_MPI_LIMB *pInputB, CRYPTO_MEM_CONTEXT *pMem);
...
unsigned CRYPTO_StrLen                              (const char *sText);

/*********************************************************************
*
*       Version, copyright, and error information
*/
const char * CRYPTO_GetVersionText                  (void);
const char * CRYPTO_GetCopyrightText                (void);
const char * CRYPTO_GetErrorText                    (int Status);
...
#define CRYPTO_TLV_ParseMPI CRYPTO_TLV_ParseINTEGER  /*emDoc ignore*/
