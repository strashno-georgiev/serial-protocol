...
#ifndef   CRYPTO_CONFIG_PRESENT_OPTIMIZE
...
#ifndef   CRYPTO_CONFIG_SM3_OPTIMIZE
...
/*********************************************************************
*
*       X.509 conformance behavior
*/

#ifndef   CRYPTO_CONFIG_X509_STRICT
  #define CRYPTO_CONFIG_X509_STRICT                  0   // By default tolerate common certificate errors
#endif
...
#ifndef   CRYPTO_ROR_U64
  #define CRYPTO_ROR_U64(X, N)   ( ((U64)(X) >> (N)) | ((U64)(X) << (64-(N))) )
#endif
...
#ifndef   CRYPTO_PTR_SUB
  #define CRYPTO_PTR_SUB(X, Y)   (unsigned)((X) - (Y))   // Subtract Y from X, X is >= Y
#endif

#ifndef   CRYPTO_UNROLL_MULTIPLIES
  #define CRYPTO_UNROLL_MULTIPLIES 0
#endif
