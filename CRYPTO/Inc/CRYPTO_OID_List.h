...
extern const U8 CRYPTO_OID_id_kp_OCSPSigning[8];  // 1.3.6.1.5.5.7.3.9
extern const U8 CRYPTO_OID_id_kp_timeStamping[8];  // 1.3.6.1.5.5.7.3.8
extern const U8 CRYPTO_OID_id_kp_emailProtection[8];  // 1.3.6.1.5.5.7.3.4
extern const U8 CRYPTO_OID_id_kp_codeSigning[8];  // 1.3.6.1.5.5.7.3.3
extern const U8 CRYPTO_OID_id_kp_clientAuth[8];  // 1.3.6.1.5.5.7.3.2
extern const U8 CRYPTO_OID_id_kp_serverAuth[8];  // 1.3.6.1.5.5.7.3.1
extern const U8 CRYPTO_OID_id_kp[7];  // 1.3.6.1.5.5.7.3
extern const U8 CRYPTO_OID_id_pe[7];  // 1.3.6.1.5.5.7.1
extern const U8 CRYPTO_OID_anyExtendedKeyUsage[4];  // 2.5.29.37.0
extern const U8 CRYPTO_OID_id_ce_extKeyUsage[3];  // 2.5.29.37
extern const U8 CRYPTO_OID_id_ce_policyConstraints[3];  // 2.5.29.36
extern const U8 CRYPTO_OID_id_ce_policyMappings[3];  // 2.5.29.33
extern const U8 CRYPTO_OID_id_ce_certificatePolicies[3];  // 2.5.29.32
extern const U8 CRYPTO_OID_id_ce_nameConstraints[3];  // 2.5.29.30
extern const U8 CRYPTO_OID_id_ce_authorityKeyIdentifier[3];  // 2.5.29.25
extern const U8 CRYPTO_OID_id_ce_keyUsage[3];  // 2.5.29.15
extern const U8 CRYPTO_OID_id_ce_basicConstraints[3];  // 2.5.29.19
extern const U8 CRYPTO_OID_id_ce_issuerAltName[3];  // 2.5.29.18
extern const U8 CRYPTO_OID_id_ce_subjectAltName[3];  // 2.5.29.17
extern const U8 CRYPTO_OID_id_ce_subjectKeyIdentifier[3];  // 2.5.29.14
extern const U8 CRYPTO_OID_id_ce_subjectDirectoryAttributes[3];  // 2.5.29.9
