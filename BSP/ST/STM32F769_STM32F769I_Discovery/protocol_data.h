...
#define PACKET_ENDING_SIZE 1

#define PACKET_ENDING ";\n"

#define MIN_PACKET_SIZE (PACKET_ID_SIZE + PACKET_CMDTP_SIZE + PACKET_SIZE_SIZE + PACKET_ADDRESS_SIZE + PACKET_CRC_SIZE + PACKET_ENDING_SIZE)
