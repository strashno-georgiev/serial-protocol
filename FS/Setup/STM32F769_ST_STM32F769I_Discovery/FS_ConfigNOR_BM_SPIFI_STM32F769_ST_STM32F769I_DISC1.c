...
File    : FS_ConfigNOR_BM_SPIFI_STM32F769_ST_STM32F769I_DISC1.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPIFI_STM32F769_ST_STM32F769I_DISC1.h"
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_STM32F769_ST_STM32F769I_DISC1);
  FS_NOR_SPIFI_SetDeviceList(0, &FS_NOR_SPI_DeviceListMacronix);
