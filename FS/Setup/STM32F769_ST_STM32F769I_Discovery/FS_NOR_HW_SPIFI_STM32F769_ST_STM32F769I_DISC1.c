...
File    : FS_NOR_HW_SPIFI_STM32F769_ST_STM32F769I_DISC1.c
...
Literature:
  ...
  [2] STM32F76xxx STM32F77xxx Errata sheet STM32F76xxx and STM32F77xxx device limitations
...
#define NOR_D0_BIT              9   // Port C
#define NOR_D1_BIT              10  // Port C
...
static int _HW_Init(U8 Unit) {
  ...
  GPIOC_AFRH    &= ~(AFR_MASK     << ((NOR_D0_BIT - 8) << 2));
  GPIOC_AFRH    |=   0x9uL        << ((NOR_D0_BIT - 8) << 2);
  ...
  GPIOC_AFRH    &= ~(AFR_MASK     << ((NOR_D1_BIT - 8) << 2));
  GPIOC_AFRH    |=   0x9uL        << ((NOR_D1_BIT - 8) << 2);
...
**********************************************************************
*/
const FS_NOR_HW_TYPE_SPIFI FS_NOR_HW_SPIFI_STM32F769_ST_STM32F769I_DISC1 = {
  _HW_Init,
  _HW_SetCmdMode,
  _HW_SetMemMode,
  _HW_ExecCmd,
